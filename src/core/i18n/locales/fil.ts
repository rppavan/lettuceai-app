...
export const filMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  hfBrowser: {
    ...
    ollamaModeNoticeBody: "Naka-disable ang mga hardware-aware na mungkahi habang napili ang remote Ollama provider. Tatakbo ang model sa hardware ng host, na hindi masusuri ng app para tantyahin ang runnability.",
    modeLlm: "LLM",
    modeImage: "Larawan",
