...
export const esMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  providers: {
    ...
    editor: {
      ...
      comfyWorkflowHelp:
        "Pega flujos de trabajo en formato API exportados desde ComfyUI. Tokens: %PROMPT%, %NEGATIVE%, %WIDTH%, %HEIGHT%, %STEPS%, %CFG%, %SEED%, %SAMPLER%, %CKPT%, %DENOISE%, %IMAGE_COUNT% y %IMAGE0%, %IMAGE1%, ... para imágenes de referencia en orden (%IMAGE% es la primera). El flujo de trabajo de imagen se usa cuando hay imágenes de referencia.",
      ...
      resolvedChatUrlDuplicate:
        "\"{{segment}}\" está al final de la URL base y al inicio del endpoint de chat, por lo que se enviará dos veces. Quítalo de uno de los dos.",
      resolvedModelsUrlDuplicate:
        "\"{{segment}}\" está al final de la URL base y al inicio del endpoint de modelos, por lo que se enviará dos veces. Quítalo de uno de los dos.",
  ...
  tour: {
    ...
    hfBrowser: {
      panel: {
        ...
        body:
          "Todo lo que ves está ajustado a esta máquina: el veredicto de arriba indica si el modelo funcionará y con qué soltura. Cambia cualquier ajuste y el veredicto se actualiza al momento.",
      },
      tabs: {
        title: "Dos formas de explorar",
        body:
          "Ajustes recomendados elige y ajusta un archivo por ti. Archivos disponibles muestra todas las descargas del repositorio si prefieres elegir a mano.",
      },
      quant: {
