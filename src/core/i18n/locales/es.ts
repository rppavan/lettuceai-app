...
export const esMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  hfBrowser: {
    ...
    ollamaModeNoticeBody: "Las sugerencias según el hardware están desactivadas mientras hay un proveedor remoto de Ollama seleccionado. El modelo se ejecutará en el hardware del host, que la app no puede inspeccionar para estimar la capacidad de ejecución.",
    modeLlm: "LLM",
    modeImage: "Imagen",
