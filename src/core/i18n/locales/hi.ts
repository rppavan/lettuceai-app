...
export const hiMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  hfBrowser: {
    ...
    ollamaModeNoticeBody: "जब रिमोट Ollama प्रदाता चुना जाता है, तो हार्डवेयर-जागरूक सुझाव अक्षम हो जाते हैं। मॉडल होस्ट के हार्डवेयर पर चलेगा, जिसकी ऐप रनैबिलिटी का अनुमान लगाने के लिए निरीक्षण नहीं कर सकती।",
    modeLlm: "LLM",
