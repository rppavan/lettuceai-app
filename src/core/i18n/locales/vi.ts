...
export const viMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  settings: {
    ...
    items: {
      ...
      performance: {
        title: "Hiệu năng LLM cục bộ",
        subtitle: "Biểu đồ tốc độ & ngữ cảnh",
      },
    },
    groups: {
  ...
  chats: {
    ...
    message: {
      ...
      regenerateMenuTitle: "Tạo lại",
      regenerateWithDirection: "Tạo lại theo hướng dẫn",
      regenerateWithDirectionDescription: "Mô tả cách phản hồi tiếp theo nên thay đổi",
      regenerateWithModel: "Tạo lại bằng mô hình khác",
      regenerateWithModelDescription: "Chọn mô hình chỉ dùng cho phản hồi này",
      regenerateModelPickerTitle: "Tạo lại bằng mô hình",
    ...
    companionRelationship: {
      ...
      pointsAboveDefault: "{{count}} điểm trên mức mặc định của nhân vật",
      pointsBelowDefault: "{{count}} điểm dưới mức mặc định của nhân vật",
    },
    companionUi: {
    ...
    memories: {
      ...
      cycleStatusAria: "Trạng thái chu kỳ ký ức",
      nextMemoryCycle: "Chu kỳ ký ức tiếp theo",
      cycleWaitingForApproval: "Đang chờ phê duyệt · {{count}} tin nhắn trong hàng đợi",
      cycleManualReady: "{{count}} tin nhắn đã sẵn sàng · chạy thủ công",
      cycleReadyAfterResponse: "Sẵn sàng chạy sau phản hồi tiếp theo",
      cycleMessagesNeeded: "Cần thêm {{count}} tin nhắn",
      cycleMessageNeeded: "Cần thêm 1 tin nhắn",
      cycleMode: "Chế độ: {{mode}}",
      cycleModeAuto: "Tự động",
      cycleModeAskFirst: "Hỏi trước",
      cycleModeManual: "Thủ công",
      conversationMessageCount: "{{count}} tin nhắn trò chuyện",
      lastCycleStatus: "Chu kỳ gần nhất: {{status}}",
      cycleStatusComplete: "hoàn tất",
      cycleStatusError: "thất bại",
      cycleStatusUnknown: "không xác định",
      skippedCycleNotice: "Chu kỳ Hỏi trước trước đó đã bị bỏ qua. Các tin nhắn của nó sẽ được gộp vào chu kỳ tiếp theo.",
      ...
      branchConversationMessageCount: "{{count}} tin nhắn trong nhánh này",
    },
    widgets: {
      types: {
        divider: {
  ...
  groupChats: {
    list: {
      ...
      deleteConfirmTitle: "Xóa nhóm?",
      deleteConfirmMessage: "Bạn có chắc muốn xóa nhóm \"{{name}}\"? Điều này sẽ xóa nhóm và tất cả cuộc trò chuyện của nhóm.",
    ...
    overrides: {
      overriddenLabel: "Đã ghi đè cho cuộc trò chuyện này",
      useGroupDefault: "Dùng mặc định của nhóm",
      participantsOverridden: "Người tham gia đã thay đổi cho cuộc trò chuyện này",
      mutedOverridden: "Người tham gia bị tắt tiếng đã thay đổi cho cuộc trò chuyện này",
    },
    memories: {
      tabMemories: "Ký ức",
      tabPinned: "Đã ghim",
    ...
    groupSettings: {
      ...
      defaultsHint: "Đây là các thiết lập mặc định của nhóm. Thay đổi sẽ áp dụng cho những cuộc trò chuyện vẫn theo mặc định của nhóm cho thiết lập đó. Cuộc trò chuyện có ghi đè riêng sẽ giữ nguyên.",
    },
    sessionSettings: {
      subtitle: "Quản lý tùy chọn trò chuyện nhóm",
      groupActionsTitle: "Nhóm",
      groupActionsSubtitle: "Cuộc trò chuyện này thuộc về {{name}}",
      newChatDesc: "Bắt đầu cuộc trò chuyện mới với thiết lập mặc định của nhóm",
      chatHistoryDesc: "Xem và quản lý các cuộc trò chuyện của nhóm này",
      groupSettingsDesc: "Chỉnh sửa thiết lập mặc định dùng chung cho mọi cuộc trò chuyện",
      overrideHint: "Các cài đặt bên dưới chỉ áp dụng cho cuộc trò chuyện này. Thay đổi một cài đặt đang theo mặc định của nhóm sẽ tạo ghi đè cho cuộc trò chuyện này.",
      enterGroupName: "Nhập tên nhóm",
      participant: "người tham gia",
      participants: "người tham gia",
      message: "tin nhắn",
    ...
    page: {
      ...
      requestFailed: "Yêu cầu trò chuyện nhóm thất bại",
  ...
  providers: {
    ...
    editor: {
      ...
      comfyWorkflowHelp: "Dán các quy trình định dạng API được xuất từ ComfyUI. Token: %PROMPT%, %NEGATIVE%, %WIDTH%, %HEIGHT%, %STEPS%, %CFG%, %SEED%, %SAMPLER%, %CKPT%, %DENOISE%, %IMAGE_COUNT%, và %IMAGE0%, %IMAGE1%, ... cho các hình ảnh tham chiếu theo thứ tự (%IMAGE% là hình đầu tiên). Quy trình hình ảnh được dùng khi có hình ảnh tham chiếu.",
      ...
      sprout: "Dùng Sprout để kiểm tra khả năng chạy",
      sproutDesc: "Truy vấn đầu dò phần cứng Sprout trên máy chủ này để kiểm tra những mô hình nào phù hợp với GPU và bộ nhớ của nó",
      sproutUrl: "URL Sprout",
      sproutApiKey: "Khóa API Sprout (tùy chọn)",
      ...
      resolvedChatUrlDuplicate: "\"{{segment}}\" nằm ở cuối Base URL và ở đầu Chat Endpoint nên sẽ bị gửi hai lần. Hãy xóa nó khỏi một trong hai.",
      resolvedModelsUrlDuplicate: "\"{{segment}}\" nằm ở cuối Base URL và ở đầu Models Endpoint nên sẽ bị gửi hai lần. Hãy xóa nó khỏi một trong hai.",
  ...
  hfBrowser: {
    ...
    ollamaVisionUnsupported: "Thị giác không khả dụng cho các mô hình được nhập vào Ollama, ngay cả khi có tệp mmproj. Chạy mô hình này cục bộ để hỗ trợ hình ảnh.",
    modeLlm: "LLM",
    modeImage: "Hình ảnh",
    clearSearch: "Xóa tìm kiếm",
    filters: "Bộ lọc",
  ...
  tour: {
    ...
    hfBrowser: {
      panel: {
        ...
        body: "Mọi thứ ở đây đều được tính theo máy này: kết luận ở trên cho biết mô hình có chạy được không và mượt đến đâu. Đổi bất kỳ cài đặt nào, kết luận sẽ cập nhật ngay.",
      },
      tabs: {
        title: "Hai cách duyệt",
        body: "Cài đặt đề xuất tự chọn và tinh chỉnh tệp cho bạn. Tệp khả dụng liệt kê mọi bản tải trong kho nếu bạn muốn tự chọn.",
      },
      quant: {
  ...
  installedModels: {
    ...
    confirm: {
      ...
      inUseBody: "Tệp này đang được dùng bởi: {{models}}. Xóa nó sẽ khiến các thiết lập đó ngừng hoạt động cho đến khi bạn chọn tệp khác.",
  ...
  editModel: {
    ...
    runtimeFacts: {
      ...
      requestedUbatch: "Microbatch yêu cầu",
      actualUbatch: "Microbatch thực tế",
      nativeFit: "Độ khớp tham số gốc",
      nativeFitContext: "Ngữ cảnh khớp gốc",
      nativeFitGpuLayers: "Lớp GPU khớp gốc",
      nativeFitMargin: "Biên an toàn khớp gốc",
      nativeFitTensorSplit: "Phân chia tensor khớp gốc",
      nativeFitError: "Lỗi khớp gốc",
      promptCacheHit: "Trúng bộ nhớ đệm prompt",
      promptCacheEntries: "Mục bộ nhớ đệm prompt",
      promptCacheMemory: "Bộ nhớ đệm prompt",
      promptCacheEvictions: "Lượt loại bỏ khỏi bộ nhớ đệm prompt",
      nativePromptSpeed: "Tốc độ xử lý prompt gốc",
      nativeGenerationSpeed: "Tốc độ tạo phản hồi gốc",
      nativePromptTime: "Thời gian xử lý prompt gốc",
      nativeGenerationTime: "Thời gian tạo phản hồi gốc",
      appGenerationOverhead: "Chi phí tạo phản hồi của ứng dụng",
      thinkingMode: "Chế độ suy nghĩ",
      thinkingDirective: "Chỉ thị suy nghĩ",
    },
    fields: {
      platform: "Platform",
      displayName: "Display name",
    ...
    providerPin: {
      action: "Ghim nhà cung cấp",
      change: "Đổi nhà cung cấp",
      title: "Ghim nhà cung cấp",
      pinned: "Nhà cung cấp đã ghim",
      clear: "Dùng định tuyến tự động",
      loading: "Đang tải nhà cung cấp...",
      error: "Không thể tải nhà cung cấp.",
      empty: "Hiện không có nhà cung cấp nào cho mô hình này.",
      cacheSupported: "Bộ nhớ đệm",
    ...
    layerPlacement: {
      ...
      multiGpuFixedLayers: "Số lớp GPU cố định ({{layers}}) đã được lưu cho mô hình này và ghi đè lên việc lập kế hoạch thông minh, do đó VRAM được thêm vào sẽ không được sử dụng. Đặt lại để định cỡ việc phân chia theo phần cứng hiện tại.",
      multiGpuFixedLayersReset: "Đặt lại về Tự động",
      multiGpuGlobalDefaultOn: "Multi-GPU đang bật theo cài đặt mặc định chung. Mô hình này được chia trên các GPU đã chọn.",
      multiGpuPinnedNotice: "Mô hình này được ghim vào {{device}} và chỉ chạy trên GPU đó, nên việc chia multi-GPU bị bỏ qua.",
      ...
      ubatchSize: "Kích thước Microbatch",
      ubatchSizeDescription: "Khối xử lý vật lý",
    },
    llamaSampler: {
  ...
  runtimeDefaults: {
    ...
    reconfigureBodyMulti: "Multi-GPU hiện đã bật. Đặt lại số lớp GPU đã lưu và ghi đè GPU đơn của mỗi mô hình cục bộ để việc lập kế hoạch thông minh có thể phân bổ từng mô hình trên các GPU đã chọn.",
    reconfigureBodySingle: "Multi-GPU hiện đã tắt. Trỏ mọi mô hình cục bộ đến {{gpu}} và đặt lại số lớp đã lưu để việc lập kế hoạch định cỡ từng mô hình cho card đó.",
    ...
    llamaGpuMemory: "Còn trống {{free}} / {{total}} GB",
    llamaGpuMinTwo: "Chọn ít nhất hai GPU để kích hoạt tải Multi-GPU.",
    llamaMultiGpuRequiresTwo: "Cần hai hoặc nhiều GPU rời. GPU tích hợp không bao giờ được sử dụng.",
    llamaDistributionTitle: "Phân phối",
    llamaDistributionDescription: "Cách mặc định để phân bổ các lớp trên các GPU đã chọn.",
    llamaDistBalanced: "Cân bằng",
    llamaDistProportional: "Tỉ lệ theo VRAM",
    llamaDistPriority: "Lấp đầy theo ưu tiên",
    llamaPriorityVramTitle: "Giới hạn VRAM GPU chính (GB)",
    llamaPriorityVramDescription: "Lấp đầy GPU đầu tiên đến mức VRAM này, sau đó tràn sang các GPU khác.",
    llamaKvPlacementTitle: "Bộ nhớ đệm KV",
    llamaKvPlacementDescription: "Nơi lưu trữ bộ nhớ đệm KV ngữ cảnh.",
    llamaKvAuto: "Tự động",
    llamaKvSplit: "Chia cùng các lớp",
    llamaKvSystemRam: "RAM hệ thống",
    llamaKvPin: "Ưu tiên GPU chính",
    llamaPinnedGpu: "GPU chính",
    llamaSingleGpuTitle: "Thiết bị GPU",
    llamaSingleGpuDescription: "Chạy mô hình này trên một GPU cụ thể thay vì thiết bị mặc định.",
    llamaSingleGpuAuto: "Tự động",
    llamaSingleGpuAutoDesc: "Để llama.cpp chọn GPU mặc định.",
    llamaManualPerModelNote: "Số lớp thủ công cho mỗi GPU được đặt theo từng mô hình trong trình chỉnh sửa mô hình.",
    llamaMultiGpuInherit: "Kế thừa",
    llamaMultiGpuSplitHint: "Chia mô hình này trên các GPU rời được chọn. GPU tích hợp không bao giờ được sử dụng.",
    llamaCpuLayers: "Lớp CPU",
    llamaManualAssignHint: "Chọn GPU ở trên để gán lớp.",
    llamaManualSumWarning: "Tổng số lớp GPU + CPU phải bằng tổng cộng",
    llamaManualPlacementBrief: "{{gpu}} lớp trên GPU · {{cpu}} trên CPU",
    llamaManualPlacementFull: "{{gpu}} trên GPU · {{cpu}} trên CPU · tổng {{total}}",
    llamaEstimatedPlacement: "Ước tính: {{breakdown}} · {{total}} lớp trên GPU",
    llamaDistBalancedDesc: "Chia đều trên các GPU đã chọn. Dành cho các card giống hệt nhau; chọn Tỉ lệ theo VRAM khi dung lượng VRAM khác nhau.",
    ...
    llamaDistManual: "Thủ công theo từng GPU",
    llamaDistManualDesc: "Tự đặt số lớp chính xác cho từng GPU và CPU.",
    ...
    llamaKvPinDesc: "Chuyển các bộ đệm tạm dùng chung đến một GPU chính được chọn. KV cache của mỗi lớp vẫn nằm trên GPU của lớp đó.",
    llamaBatchTitle: "Kích thước Batch Prompt",
    llamaBatchDescription: "Batch prompt logic tối đa. Để trống dùng 512.",
    llamaUbatchTitle: "Kích thước Microbatch Prompt",
    llamaUbatchDescription: "Khối xử lý vật lý dùng bên trong một batch logic. Giá trị thấp hơn giảm mức dùng bộ nhớ.",
  },
  loraSelector: {
    title: "Thiết kế LoRA",
  ...
  performance: {
    title: "Hiệu năng LLM cục bộ",
    subtitle: "Tốc độ giải mã và mức dùng ngữ cảnh trong các lượt tạo cục bộ của bạn",
    empty: "Chưa ghi nhận lượt tạo cục bộ nào. Chạy một mô hình cục bộ trong trò chuyện để xem biểu đồ hiệu năng.",
    refresh: "Làm mới",
    clear: "Xóa lịch sử",
    clearConfirmTitle: "Xóa lịch sử hiệu năng?",
    clearConfirmBody: "Thao tác này xóa toàn bộ số liệu tạo cục bộ đã ghi nhận và không thể hoàn tác.",
    cleared: "Đã xóa lịch sử hiệu năng",
    stats: {
      runs: "Lượt đã ghi nhận",
      avgSpeed: "Tốc độ giải mã trung bình",
      peakSpeed: "Tốc độ giải mã cao nhất",
      avgTtft: "Token đầu tiên trung bình",
    },
    charts: {
      speedByRun: "Tốc độ giải mã theo lượt",
      speedByRunSub: "Token mỗi giây, từ cũ nhất đến mới nhất",
      speedVsContext: "Tốc độ so với kích thước ngữ cảnh",
      speedVsContextSub: "Tốc độ giải mã theo độ dài ngữ cảnh",
      detailTitle: "Chi tiết lượt tạo",
      latestTitle: "Lượt tạo gần nhất, theo từng giây",
      latestSub: "Tốc độ giải mã và mức lấp đầy ngữ cảnh trong lượt gần nhất",
      speedAxis: "tok/s",
      contextAxis: "% ngữ cảnh",
      legendSpeed: "Tốc độ giải mã (tok/s)",
      legendContext: "Mức lấp đầy ngữ cảnh (%)",
      runAxis: "Lượt (từ cũ nhất đến mới nhất)",
      contextSizeAxis: "Kích thước ngữ cảnh (token)",
      elapsedAxis: "giây",
      noSamples: "Không có mẫu theo giây nào được ghi nhận cho lượt tạo này.",
    },
    detail: {
      decodeSpeed: "Tốc độ giải mã",
      nativePromptSpeed: "Tốc độ xử lý prompt gốc",
      nativeGenerationSpeed: "Tốc độ tạo phản hồi gốc",
      ...
      gpuLayers: "Lớp GPU",
      kvType: "KV cache",
      elapsed: "Thời gian tạo",
      nativeGenerationTime: "Thời gian tính toán tạo phản hồi gốc",
      appOverhead: "Chi phí ứng dụng",
      finishReason: "Lý do kết thúc",
      modelSize: "Kích thước mô hình",
    },
    list: {
      title: "Lượt tạo gần đây",
      speed: "{{value}} tok/s",
      ttft: "{{value}} ms",
      unknownModel: "Mô hình không xác định",
    },
