...
export const jaMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  settings: {
    ...
    items: {
      ...
      performance: {
        title: "ローカルLLMのパフォーマンス",
        subtitle: "速度とコンテキストのグラフ",
      },
    },
    groups: {
      configuration: "設定",
  ...
  chats: {
    ...
    message: {
      ...
      regenerateMenuTitle: "再生成",
      regenerateWithDirection: "方向を指定して再生成",
      regenerateWithDirectionDescription: "次の返信をどのように変えるか記述してください",
      regenerateWithModel: "別のモデルで再生成",
      regenerateWithModelDescription: "この返信にのみ使うモデルを選択",
      regenerateModelPickerTitle: "モデルを選んで再生成",
    ...
    companionRelationship: {
      ...
      goals: "目標",
      likes: "好きなもの・お気に入り",
      pointsAboveDefault: "キャラクターのデフォルトより{{count}}ポイント高い",
      pointsBelowDefault: "キャラクターのデフォルトより{{count}}ポイント低い",
    },
    companionUi: {
    ...
    memories: {
      ...
      cycleStatusAria: "メモリサイクルの状態",
      nextMemoryCycle: "次のメモリサイクル",
      cycleWaitingForApproval: "承認待ち · {{count}}件のメッセージが保留中",
      cycleManualReady: "{{count}}件のメッセージが準備完了 · 手動で実行できます",
      cycleReadyAfterResponse: "次の応答の後に実行できます",
      cycleMessagesNeeded: "あと{{count}}件のメッセージが必要です",
      cycleMessageNeeded: "あと1件のメッセージが必要です",
      cycleMode: "モード: {{mode}}",
      cycleModeAuto: "自動",
      cycleModeAskFirst: "確認する",
      cycleModeManual: "手動",
      conversationMessageCount: "{{count}}件の会話メッセージ",
      lastCycleStatus: "前回のサイクル: {{status}}",
      cycleStatusComplete: "完了",
      cycleStatusError: "失敗",
      cycleStatusUnknown: "不明",
      skippedCycleNotice: "前回の「確認する」サイクルはスキップされました。そのメッセージは次のサイクルに含まれます。",
      ...
      branchConversationMessageCount: "この分岐の{{count}}件のメッセージ",
    },
    widgets: {
      types: {
        divider: {
  ...
  groupChats: {
    list: {
      ...
      deleteConfirmMessage: "グループ「{{name}}」を削除してもよろしいですか？グループとそのすべてのチャットが削除されます。",
    ...
    overrides: {
      overriddenLabel: "このチャットでは上書きされています",
      useGroupDefault: "グループのデフォルトを使用",
      participantsOverridden: "このチャットでは参加者が変更されています",
      mutedOverridden: "このチャットではミュートされた参加者が変更されています",
    },
    memories: {
      tabMemories: "メモリ",
      tabPinned: "ピン留め",
    ...
    groupSettings: {
      ...
      defaultsHint: "これらはグループのデフォルト設定です。変更は、その設定でグループのデフォルトに従っているチャットに適用されます。独自の上書きを持つチャットはそのまま維持されます。",
    },
    sessionSettings: {
      subtitle: "グループチャットの設定を管理",
      groupActionsTitle: "グループ",
      groupActionsSubtitle: "このチャットは{{name}}に属しています",
      newChatDesc: "グループのデフォルト設定で新しいチャットを開始",
      chatHistoryDesc: "このグループのチャットを表示・管理",
      groupSettingsDesc: "すべてのチャットで共有されるデフォルト設定を編集",
      overrideHint: "以下の設定はこのチャットにのみ適用されます。グループのデフォルトに従っている設定を変更すると、このチャット専用の上書きが作成されます。",
      enterGroupName: "グループ名を入力",
      participant: "参加者",
      participants: "参加者",
      message: "メッセージ",
  ...
  providers: {
    ...
    editor: {
      ...
      comfyWorkflowHelp: "ComfyUI からエクスポートした API 形式のワークフローを貼り付けてください。トークン: %PROMPT%、%NEGATIVE%、%WIDTH%、%HEIGHT%、%STEPS%、%CFG%、%SEED%、%SAMPLER%、%CKPT%、%DENOISE%、%IMAGE_COUNT%、および参照画像を順番に指定する %IMAGE0%、%IMAGE1%、...（%IMAGE% が最初）。参照画像がある場合は画像ワークフローが使用されます。",
      streaming: "ストリーミング",
      ...
      sprout: "実行可能性の確認に Sprout を使用",
      sproutDesc: "このホスト上の Sprout ハードウェアプローブに問い合わせて、どのモデルが GPU とメモリに収まるかを確認します",
      sproutUrl: "Sprout URL",
      sproutApiKey: "Sprout API キー (任意)",
      ...
      resolvedChatUrlDuplicate: "\"{{segment}}\" がBase URLの末尾とChat Endpointの先頭の両方にあるため、二重に送信されます。どちらか一方から削除してください。",
      resolvedModelsUrlDuplicate: "\"{{segment}}\" がBase URLの末尾とModels Endpointの先頭の両方にあるため、二重に送信されます。どちらか一方から削除してください。",
      fetchModels: "モデルを取得",
  ...
  hfBrowser: {
    ...
    ollamaVisionUnsupported: "Ollama にインポートされたモデルでは、mmproj ファイルがあってもビジョンは利用できません。画像サポートを利用するには、このモデルをローカルで実行してください。",
    modeLlm: "LLM",
    modeImage: "画像",
    clearSearch: "検索をクリア",
    filters: "フィルター",
  ...
  tour: {
    editModelLlama: {
      context: {
        title: "コンテキストの量を選ぼう",
        body: "コンテキストが大きいほど会話の記憶は長くなりますが、VRAMをどんどん消費します。自動ならハードウェアに合わせてサイズを決めてくれますし、いつでも自分で調整できます。",
      },
      presets: {
        title: "プリセットがチューニングを代行",
        body: "バランス、スループット、VRAM節約、CPU + RAM。ワンタップで下のすべてに適切な値が設定され、あとから微調整もできます。",
      },
      gpu: {
        title: "GPUオフロードはここ",
        body: "自動なら空きVRAMからレイヤーを計画します。GPUが複数あればここでモデルをカード間に分割したり、設定のグローバルなデフォルトに従うこともできます。",
      },
      report: {
        title: "実際に何が起きたか確認",
        body: "ロードのたびに、このレポートが実際の動作を表示します：GPU上のレイヤー、使用されたコンテキスト、フォールバックの有無。遅いと感じたら、まずここを見てください。",
      },
    },
    runtimeDefaults: {
      storage: {
        title: "モデルはここに保存されます",
        body: "このフォルダにダウンロードしたモデルファイルがすべて入っています。空き容量が足りなくなったら、いつでも別のドライブに移動できます。",
      },
      llama: {
        title: "すべてのローカルモデルのデフォルト",
        body: "ここで設定したコンテキスト、KV cache、GPUの動作はすべてのローカルモデルに適用されます。各モデルは自身のエディターから上書きできます。",
      },
      multiGpu: {
        title: "モデルを複数のGPUに分割",
    ...
    hfBrowser: {
      panel: {
        title: "あなた専用の適合レポート",
        body: "ここに表示される内容はすべてこのマシンに合わせて計算されています。上部の判定はモデルが動くか、どれだけ快適かを示します。設定を変えると判定もすぐに更新されます。",
      },
      tabs: {
        title: "2つの見方",
        body: "おすすめ設定はファイルの選択と調整を自動で行います。手動で選びたいときは、利用可能なファイルでリポジトリ内の全ダウンロードを確認できます。",
      },
      quant: {
        title: "量子化を選ぼう",
        body: "小さい量子化ほどメモリ使用量は減りますが、品質が少し落ちます。各ファイルの横のスコアが、あなたのハードウェアへの適合度を教えてくれます。",
      },
      context: {
        title: "コンテキストもメモリを消費します",
        body: "モデルファイルだけがすべてではありません：コンテキストのトークン一つひとつにも領域が必要です。このスライダーで、あなたのマシンでどこまで上げられるかがわかります。",
      },
      offload: {
        title: "モデルはどこで動かす？",
        body: "自動なら選んでくれます。収まるならGPUが最速、CPUは遅いけれど安全な道、ミックスはその中間です。あとでモデルエディターから変更できます。",
      },
      kvLocation: {
        title: "会話キャッシュの置き場所",
        body: "KV cacheをVRAMに置くのが最速です。RAMに移せば、余裕がないときにGPUをより多くのレイヤーに使えます。",
      },
    },
    groupChatDetail: {
      title: {
        title: "グループ設定は名前の先に",
        body: "グループ名をタップすると、参加者の管理、次の話者の選び方の設定、休ませたいキャラクターのミュートができます。",
      },
      participants: {
        title: "この部屋のみんな",
        body: "このグループのキャラクターたちです。タップして、会話に参加するメンバーの追加、削除、並べ替えができます。",
      },
      memory: {
        title: "グループはみんなで記憶する",
        body: "グループの記憶は会話全体で共有されます。ブレインをタップして、グループが知っていることを確認、ピン留め、整理できます。",
      },
      composer: {
        title: "何か話しかけよう",
        body: "ここにメッセージを入力します。次に誰が答えるかは、グループ設定で選んだ話者選択によって決まります。",
      },
    },
    dynamicMemory: {
      enable: {
        title: "ダイナミックメモリをオンに",
        body: "有効にすると、アプリがチャットから重要な事実をそっと抽出して、あとで思い出します。キャラクターが大事なことを覚えていられるように。",
      },
      mode: {
        title: "コントロールの度合いを選ぼう",
        body: "自動はバックグラウンドでメモリ更新を実行し、確認するは保存前にあなたに確認し、手動はすべてあなたに任せます。",
      },
      preset: {
        title: "プロファイルがチューニングを設定",
        body: "プロファイルを選ぶと、減衰、バジェット、しきい値がまとめて設定されます。詳細設定からすべて微調整できます。",
      },
      embedding: {
  ...
  installedModels: {
    ...
    confirm: {
      ...
      inUseBody: "このファイルは {{models}} で使用されています。削除すると、別のファイルを指定するまでそれらの設定は動作しなくなります。",
  ...
  editModel: {
    ...
    runtimeFacts: {
      ...
      requestedUbatch: "リクエストされたマイクロバッチ",
      actualUbatch: "実際のマイクロバッチ",
      nativeFit: "ネイティブパラメータ適合",
      nativeFitContext: "ネイティブ適合コンテキスト",
      nativeFitGpuLayers: "ネイティブ適合GPUレイヤー",
      nativeFitMargin: "ネイティブ適合セーフティマージン",
      nativeFitTensorSplit: "ネイティブ適合テンソル分割",
      nativeFitError: "ネイティブ適合エラー",
      promptCacheHit: "プロンプトキャッシュヒット",
      promptCacheEntries: "プロンプトキャッシュエントリ数",
      promptCacheMemory: "プロンプトキャッシュメモリ",
      promptCacheEvictions: "プロンプトキャッシュのエビクション数",
      nativePromptSpeed: "ネイティブプロンプト速度",
      nativeGenerationSpeed: "ネイティブ生成速度",
      nativePromptTime: "ネイティブプロンプト時間",
      nativeGenerationTime: "ネイティブ生成時間",
      appGenerationOverhead: "アプリ生成オーバーヘッド",
      thinkingMode: "思考モード",
      thinkingDirective: "思考ディレクティブ",
    },
    fields: {
      platform: "Platform",
    ...
    providerPin: {
      ...
      clear: "自動ルーティングを使用",
      loading: "プロバイダーを読み込み中...",
      error: "プロバイダーを読み込めませんでした。",
      empty: "このモデルで現在利用可能なプロバイダーはありません。",
      cacheSupported: "キャッシュ",
    ...
    layerPlacement: {
      ...
      multiGpuFixedLayers: "このモデルには固定 GPU レイヤー数 ({{layers}}) が保存されており、スマートプランニングより優先されるため、追加した VRAM は使用されません。現在のハードウェアに合わせて分割するにはリセットしてください。",
      multiGpuFixedLayersReset: "自動にリセット",
      multiGpuGlobalDefaultOn: "グローバル設定によりマルチGPUが有効です。このモデルは選択したGPUに分割されます。",
      multiGpuPinnedNotice: "このモデルは{{device}}に固定されており、そのGPUのみで動作するため、マルチGPU分割は行われません。",
      ...
      ubatchSize: "マイクロバッチサイズ",
      ubatchSizeDescription: "物理計算バッチ",
    },
    llamaSampler: {
      samplerProfile: "サンプラープロファイル",
  ...
  runtimeDefaults: {
    ...
    reconfigureBodyMulti: "Multi-GPU が有効になりました。スマートプランニングが選択した GPU 全体にモデルを分散できるよう、すべてのローカルモデルの保存済み GPU レイヤー数とシングル GPU の上書き設定をリセットします。",
    reconfigureBodySingle: "Multi-GPU が無効になりました。すべてのローカルモデルを {{gpu}} に割り当て、保存済みのレイヤー数をリセットして、そのカードに合わせてプランニングできるようにします。",
    ...
    llamaGpuMemory: "空き {{free}} / {{total}} GB",
    llamaGpuMinTwo: "Multi-GPU の読み込みを有効にするには、少なくとも 2 つの GPU を選択してください。",
    llamaMultiGpuRequiresTwo: "2 つ以上の専用 GPU が必要です。統合 GPU は使用されません。",
    llamaDistributionTitle: "分散方式",
    llamaDistributionDescription: "選択した GPU にレイヤーを分散させるデフォルトの方法です。",
    llamaDistBalanced: "均等",
    llamaDistProportional: "VRAM に比例",
    llamaDistPriority: "優先充填",
    llamaPriorityVramTitle: "プライマリ GPU の VRAM 上限（GB）",
    llamaPriorityVramDescription: "最初の GPU をこの VRAM 量まで使用し、超過分を他へ振り分けます。",
    llamaKvPlacementTitle: "KV キャッシュ",
    llamaKvPlacementDescription: "コンテキストの KV キャッシュを保存する場所です。",
    llamaKvAuto: "自動",
    llamaKvSplit: "レイヤーと一緒に分割",
    llamaKvSystemRam: "システム RAM",
    llamaKvPin: "メイン GPU を優先",
    llamaPinnedGpu: "メイン GPU",
    llamaSingleGpuTitle: "GPU デバイス",
    llamaSingleGpuDescription: "このモデルをデフォルトのデバイスではなく特定の GPU で実行します。",
    llamaSingleGpuAuto: "自動",
    llamaSingleGpuAutoDesc: "llama.cpp にデフォルトの GPU を選択させます。",
    llamaManualPerModelNote: "GPU ごとの手動レイヤー数は、モデルエディターでモデルごとに設定します。",
    llamaMultiGpuInherit: "継承",
    llamaMultiGpuSplitHint: "このモデルを選択した個別 GPU に分割します。統合 GPU は使用されません。",
    llamaCpuLayers: "CPU レイヤー",
    llamaManualAssignHint: "レイヤーを割り当てる GPU を上で選択してください。",
    llamaManualSumWarning: "GPU + CPU レイヤーの合計が総数と一致する必要があります",
    llamaManualPlacementBrief: "GPU に {{gpu}} レイヤー · CPU に {{cpu}}",
    llamaManualPlacementFull: "GPU に {{gpu}} · CPU に {{cpu}} · 合計 {{total}}",
    llamaEstimatedPlacement: "推定: {{breakdown}} · GPU に {{total}} レイヤー",
    llamaDistBalancedDesc: "選択した GPU に均等に分割します。同一の GPU 向けです。VRAM 容量が異なる場合は「VRAM に比例」を選択してください。",
    ...
    llamaDistManual: "GPU ごとに手動設定",
    llamaDistManualDesc: "各 GPU と CPU のレイヤー数を自分で正確に指定します。",
    ...
    llamaKvPinDesc: "共有スクラッチバッファーを選択した 1 つのメイン GPU に割り当てます。各レイヤーの KV キャッシュはそのレイヤーの GPU に残ります。",
    llamaBatchTitle: "プロンプトバッチサイズ",
    llamaBatchDescription: "論理プロンプトバッチの最大値。空欄の場合は512を使用します。",
    llamaUbatchTitle: "プロンプトマイクロバッチサイズ",
    llamaUbatchDescription: "論理バッチ内で使用される物理計算バッチ。値を小さくするとメモリ使用量が減ります。",
  },
  loraSelector: {
    title: "デザイン LoRA",
    none: "LoRA 未選択",
  ...
  performance: {
    title: "ローカルLLMのパフォーマンス",
    subtitle: "ローカル生成全体のデコード速度とコンテキスト使用状況",
    empty: "まだローカル生成の記録がありません。チャットでローカルモデルを実行すると、パフォーマンスグラフが表示されます。",
    refresh: "更新",
    clear: "履歴をクリア",
    clearConfirmTitle: "パフォーマンス履歴をクリアしますか？",
    clearConfirmBody: "記録されたすべてのローカル生成の指標が削除されます。この操作は元に戻せません。",
    cleared: "パフォーマンス履歴をクリアしました",
    stats: {
      runs: "記録された実行回数",
      avgSpeed: "平均デコード速度",
      peakSpeed: "最大デコード速度",
    ...
    charts: {
      speedByRun: "実行ごとのデコード速度",
      speedByRunSub: "秒間トークン数（古い順から新しい順）",
      speedVsContext: "速度とコンテキストサイズ",
      speedVsContextSub: "コンテキスト長に対するデコード速度",
      detailTitle: "生成の詳細",
      latestTitle: "最新の生成（秒単位）",
      latestSub: "直近の実行におけるデコード速度とコンテキスト使用率",
      speedAxis: "tok/s",
      contextAxis: "コンテキスト %",
      legendSpeed: "デコード速度 (tok/s)",
      legendContext: "コンテキスト使用率 (%)",
      runAxis: "実行（古い順から新しい順）",
      contextSizeAxis: "コンテキストサイズ（トークン）",
      elapsedAxis: "秒",
      noSamples: "この生成には秒単位のサンプルが記録されていません。",
    },
    detail: {
      decodeSpeed: "デコード速度",
      nativePromptSpeed: "ネイティブプロンプト速度",
      nativeGenerationSpeed: "ネイティブ生成速度",
      firstToken: "最初のトークンまでの時間",
      promptTokens: "プロンプトトークン",
      outputTokens: "出力トークン",
      totalTokens: "合計トークン",
      context: "コンテキストウィンドウ",
      ...
      kvType: "KVキャッシュ",
      elapsed: "生成時間",
      nativeGenerationTime: "ネイティブ生成計算",
      appOverhead: "アプリのオーバーヘッド",
      finishReason: "終了理由",
      modelSize: "モデルサイズ",
    },
    list: {
