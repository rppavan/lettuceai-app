...
export const ptMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  hfBrowser: {
    ...
    ollamaModeNoticeBody: "As sugestões com base no hardware são desativadas enquanto um provedor Ollama remoto está selecionado. O modelo rodará no hardware do host, que o app não pode inspecionar para estimar a executabilidade.",
    modeLlm: "LLM",
    modeImage: "Imagem",
