...
export const ptMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  providers: {
    ...
    editor: {
      ...
      comfyWorkflowHelp:
        "Cole fluxos de trabalho no formato API exportados do ComfyUI. Tokens: %PROMPT%, %NEGATIVE%, %WIDTH%, %HEIGHT%, %STEPS%, %CFG%, %SEED%, %SAMPLER%, %CKPT%, %DENOISE%, %IMAGE_COUNT% e %IMAGE0%, %IMAGE1%, ... para imagens de referência em ordem (%IMAGE% é a primeira). O fluxo de trabalho de imagem é usado quando há imagens de referência.",
      streaming: "Streaming",
  ...
  tour: {
    ...
    hfBrowser: {
      panel: {
        ...
        body:
          "Tudo aqui é dimensionado para esta máquina: o veredito no topo diz se o modelo vai rodar e com que folga. Mude qualquer configuração e o veredito atualiza na hora.",
      },
      tabs: {
        title: "Duas formas de navegar",
        body:
          "Configurações recomendadas escolhe e ajusta um arquivo para você. Arquivos disponíveis lista todos os downloads do repositório se preferir escolher manualmente.",
      },
      quant: {
  ...
  installedModels: {
    ...
    confirm: {
      ...
      inUseBody:
        "Este arquivo é usado por: {{models}}. Excluí-lo fará essas configurações pararem de funcionar até você escolher outro arquivo.",
  ...
  editModel: {
    ...
    providerPin: {
      action: "Fixar fornecedor", change: "Alterar fornecedor", title: "Fixar fornecedor",
      pinned: "Fornecedor fixado", clear: "Usar roteamento automático",
      loading: "Carregando fornecedores...", error: "Não foi possível carregar os fornecedores.",
      empty: "Nenhum fornecedor está disponível para este modelo.", cacheSupported: "Cache",
      sortButtonHint: "Alterar ordenação dos fornecedores",
      sort: { price: "Mais baratos", uptime: "Disponibilidade", caching: "Cache", alphabetical: "A–Z" },
    },
    sdOffload: {
      auto: "Automático",
