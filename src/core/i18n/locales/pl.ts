  ...
  providers: {
    ...
    editor: {
      ...
      resolvedChatUrlDuplicate:
        "\"{{segment}}\" znajduje się na końcu Base URL i na początku Chat Endpoint, więc zostanie wysłane dwukrotnie. Usuń je z jednego z nich.",
      resolvedModelsUrlDuplicate:
        "\"{{segment}}\" znajduje się na końcu Base URL i na początku Models Endpoint, więc zostanie wysłane dwukrotnie. Usuń je z jednego z nich.",
  ...
  tour: {
    ...
    hfBrowser: {
      panel: {
        ...
        body:
          "Wszystko tutaj jest dopasowane do tej maszyny: werdykt u góry mówi, czy model zadziała i jak płynnie. Zmień dowolne ustawienie, a werdykt zaktualizuje się na żywo.",
      },
      tabs: {
        title: "Dwa sposoby przeglądania",
        body:
          "Zalecane ustawienia wybierają i dostrajają plik za ciebie. Dostępne pliki pokazują wszystkie pliki repozytorium, jeśli wolisz wybrać samodzielnie.",
      },
      quant: {
