...
export const plMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  settings: {
    ...
    items: {
      ...
      performance: {
        title: "Wydajność lokalnych LLM",
        subtitle: "Wykresy prędkości i kontekstu",
      },
    },
    groups: {
  ...
  chats: {
    ...
    message: {
      ...
      regenerateWithDirection: "Regeneruj z wytyczną",
      regenerateWithDirectionDescription: "Opisz, jak powinna zmienić się następna odpowiedź",
    ...
    actions: {
      ...
      mtpEfficiency: "Wydajność dekodowania spekulatywnego MTP (tokeny na rundę, akceptacja szkicu)",
    ...
    companionRelationship: {
      ...
      pointsAboveDefault: "{{count}} punktów powyżej wartości domyślnej postaci",
      pointsBelowDefault: "{{count}} punktów poniżej wartości domyślnej postaci",
    },
    companionUi: {
      relationship: "Relacja",
    ...
    memories: {
      ...
      cycleStatusAria: "Stan cyklu pamięci",
      nextMemoryCycle: "Następny cykl pamięci",
      cycleWaitingForApproval: "Oczekiwanie na zatwierdzenie · {{count}} wiadomości w kolejce",
      cycleManualReady: "{{count}} wiadomości gotowych · uruchom ręcznie",
      cycleReadyAfterResponse: "Gotowy do uruchomienia po następnej odpowiedzi",
      cycleMessagesNeeded: "Potrzeba jeszcze {{count}} wiadomości",
      cycleMessageNeeded: "Potrzebna jeszcze 1 wiadomość",
      cycleMode: "Tryb: {{mode}}",
      cycleModeAuto: "Automatyczny",
      cycleModeAskFirst: "Pytaj najpierw",
      cycleModeManual: "Ręczny",
      conversationMessageCount: "{{count}} wiadomości rozmowy",
      lastCycleStatus: "Ostatni cykl: {{status}}",
      cycleStatusComplete: "zakończony",
      cycleStatusError: "nieudany",
      cycleStatusUnknown: "nieznany",
      skippedCycleNotice: "Poprzedni cykl w trybie \"Pytaj najpierw\" został pominięty. Jego wiadomości zostaną uwzględnione w następnym cyklu.",
      ...
      branchConversationMessageCount: "{{count}} wiadomości w tej gałęzi",
    },
    widgets: {
      types: {
        divider: {
  ...
  groupChats: {
    list: {
      ...
      deleteConfirmTitle: "Usunąć grupę?",
      deleteConfirmMessage: "Czy na pewno chcesz usunąć grupę \"{{name}}\"? Spowoduje to usunięcie grupy i wszystkich jej czatów.",
    ...
    overrides: {
      ...
      useGroupDefault: "Użyj domyślnych grupy",
    ...
    groupSettings: {
      ...
      defaultsHint: "To są domyślne ustawienia grupy. Zmiany dotyczą czatów, które nadal korzystają z domyślnych ustawień grupy. Czaty z własnym nadpisaniem zachowują je.",
    },
    sessionSettings: {
      subtitle: "Zarządzaj preferencjami czatu grupowego",
      groupActionsTitle: "Grupa",
      groupActionsSubtitle: "Ten czat należy do {{name}}",
      newChatDesc: "Rozpocznij nowy czat z domyślnymi ustawieniami grupy",
      chatHistoryDesc: "Przeglądaj czaty tej grupy i zarządzaj nimi",
      groupSettingsDesc: "Edytuj ustawienia domyślne wspólne dla wszystkich czatów",
      overrideHint: "Poniższe ustawienia dotyczą tylko tego czatu. Zmiana ustawienia korzystającego z domyślnych grupy tworzy nadpisanie dla tego czatu.",
      enterGroupName: "Wprowadź nazwę grupy",
      participant: "uczestnik",
      participants: "uczestników",
      message: "wiadomość",
    ...
    messageActionsExtra: {
      ...
      branchToCharacter: "Rozgałęź do czatu 1 na 1 od tego miejsca",
      selectCharacterForBranch: "Kontynuuj od tego momentu w prywatnym czacie z tą postacią",
    },
    timeAgo: {
      justNow: "przed chwilą",
      minutesAgo: "{{count}} min. temu",
  ...
  providers: {
    ...
    editor: {
      ...
      comfyWorkflowHelp: "Wklej przepływy pracy w formacie API wyeksportowane z ComfyUI. Tokeny: %PROMPT%, %NEGATIVE%, %WIDTH%, %HEIGHT%, %STEPS%, %CFG%, %SEED%, %SAMPLER%, %CKPT%, %DENOISE%, %IMAGE_COUNT% oraz %IMAGE0%, %IMAGE1%, ... dla obrazów referencyjnych w kolejności (%IMAGE% to pierwszy). Przepływ pracy obrazu jest używany, gdy obecne są obrazy referencyjne.",
      ...
      sprout: "Użyj Sprout do sprawdzenia możliwości uruchomienia",
      sproutDesc: "Wysyłaj zapytania do sondy sprzętowej Sprout na tym hoście, aby sprawdzić, które modele mieszczą się w jego GPU i pamięci",
      ...
      resolvedChatUrl: "Żądania trafią do",
      resolvedChatUrlDuplicate: "\"{{segment}}\" znajduje się na końcu Base URL i na początku Chat Endpoint, więc zostanie wysłane dwukrotnie. Usuń je z jednego z nich.",
      resolvedModelsUrlDuplicate: "\"{{segment}}\" znajduje się na końcu Base URL i na początku Models Endpoint, więc zostanie wysłane dwukrotnie. Usuń je z jednego z nich.",
  ...
  installedModels: {
    ...
    confirm: {
      ...
      inUseBody: "Ten plik jest używany przez: {{models}}. Po usunięciu te konfiguracje przestaną działać, dopóki nie wskażesz innego pliku.",
  ...
  hfBrowser: {
    ...
    mobileOllamaTitle: "Połącz dostawcę Ollama",
    mobileOllamaCta: "Dodaj dostawcę Ollama",
    ollamaModeNoticeTitle: "Rekomendacje niedostępne",
    ollamaModeNoticeBody: "Ten model działa na zdalnym hoście, więc aplikacja nie może samodzielnie oszacować możliwości uruchomienia. Włącz Sprout dla tego dostawcy Ollama, aby zbadać GPU i pamięć hosta, a rekomendacje będą odzwierciedlać tę maszynę.",
    getSprout: "Pobierz Sprout",
    ollamaVisionUnsupported: "Wizja nie jest dostępna dla modeli zaimportowanych do Ollama, nawet z plikiem mmproj. Uruchom ten model lokalnie, aby uzyskać obsługę obrazów.",
    modeLlm: "LLM",
    modeImage: "Obraz",
    clearSearch: "Wyczyść wyszukiwanie",
    filters: "Filtry",
  ...
  chatAppearance: {
    ...
    messageBubbles: {
      ...
      showMtp: "Pokaż statystyki MTP",
      showMtpDesc: "Wyświetlaj wydajność dekodowania spekulatywnego (tokeny na rundę i akceptacja szkicu) dla modeli lokalnych obsługujących MTP.",
      infoPlacement: {
  ...
  tour: {
    editModelLlama: {
      context: {
        title: "Wybierz, ile kontekstu użyć",
        body: "Większy kontekst to dłuższa pamięć rozmowy, ale szybko zjada VRAM. Auto dobiera rozmiar do Twojego sprzętu, a Ty zawsze możesz ustawić go samodzielnie.",
      },
      presets: {
        title: "Presety stroją wszystko za Ciebie",
        body: "Zrównoważony, Przepustowość, Oszczędzanie VRAM, CPU + RAM. Jedno stuknięcie ustawia rozsądne wartości dla wszystkiego poniżej, a potem wciąż możesz je dopracować.",
      },
      gpu: {
        title: "Tu mieszka odciążanie GPU",
        body: "Auto planuje warstwy na podstawie wolnego VRAM. Przy więcej niż jednym GPU możesz tu podzielić model między karty lub trzymać się globalnego domyślnego z ustawień.",
      },
      report: {
        title: "Zobacz, co naprawdę się stało",
        body: "Po każdym załadowaniu ten raport pokazuje, co faktycznie działało: warstwy na GPU, użyty kontekst, ewentualne fallbacki. Gdy coś wydaje się wolne, najpierw zajrzyj tutaj.",
      },
    },
    runtimeDefaults: {
      storage: {
        title: "Tu mieszkają Twoje modele",
        body: "Ten folder zawiera każdy pobrany plik modelu. Możesz go przenieść na inny dysk, gdy zabraknie Ci miejsca.",
      },
      llama: {
        title: "Domyślne dla każdego lokalnego modelu",
        body: "Kontekst, KV cache i zachowanie GPU ustawione tutaj dotyczą wszystkich lokalnych modeli. Każdy model może je nadpisać we własnym edytorze.",
      },
      multiGpu: {
        title: "Podziel modele między GPU",
        body: "Przy dwóch lub więcej kartach graficznych włącz to, aby rozłożyć warstwy między nie. Modele ustawione na Dziedzicz automatycznie podążają za tym przełącznikiem.",
      },
    },
    hfBrowser: {
      panel: {
        title: "Twój osobisty raport dopasowania",
        body: "Wszystko tutaj jest dopasowane do tej maszyny: werdykt u góry mówi, czy model zadziała i jak płynnie. Zmień dowolne ustawienie, a werdykt zaktualizuje się na żywo.",
      },
      tabs: {
        title: "Dwa sposoby przeglądania",
        body: "Zalecane ustawienia wybierają i dostrajają plik za ciebie. Dostępne pliki pokazują wszystkie pliki repozytorium, jeśli wolisz wybrać samodzielnie.",
      },
      quant: {
        title: "Wybierz kwantyzację",
        body: "Mniejsze kwanty zużywają mniej pamięci, ale tracą odrobinę jakości. Wynik obok każdego pliku mówi, jak dobrze pasuje do Twojego sprzętu.",
      },
      context: {
        title: "Kontekst też kosztuje pamięć",
        body: "Plik modelu to nie wszystko: każdy token kontekstu też potrzebuje miejsca. Ten suwak pokazuje, jak daleko możesz się posunąć na swojej maszynie.",
      },
      offload: {
        title: "Gdzie ma działać model?",
        body: "Auto wybiera za Ciebie. GPU jest najszybsze, jeśli model się mieści, CPU to wolna, ale bezpieczna droga, a Mieszany jest pośrodku. Możesz to później zmienić w edytorze modelu.",
      },
      kvLocation: {
        title: "Gdzie mieszka pamięć podręczna rozmowy",
        body: "Trzymanie KV cache w VRAM jest najszybsze. Przeniesienie go do RAM zwalnia GPU na więcej warstw, gdy robi się ciasno.",
      },
    },
    groupChatDetail: {
      title: {
        title: "Ustawienia grupy kryją się za nazwą",
        body: "Stuknij nazwę grupy, aby zarządzać uczestnikami, wybrać sposób wyboru następnego mówcy i wyciszyć postacie, które mają zrobić sobie przerwę.",
      },
      participants: {
        title: "Wszyscy w pokoju",
        body: "To są postacie w tej grupie. Stuknij, aby dodać, usunąć lub zmienić kolejność uczestników rozmowy.",
      },
      memory: {
        title: "Grupa pamięta razem",
        body: "Wspomnienia grupy są współdzielone w całej rozmowie. Stuknij mózg, aby zobaczyć, przypiąć lub uporządkować to, co grupa wie.",
      },
      composer: {
        title: "Powiedz coś",
        body: "Wpisz tutaj swoją wiadomość. Kto odpowie następny, zależy od wyboru mówcy ustawionego w ustawieniach grupy.",
      },
    },
    dynamicMemory: {
      enable: {
        title: "Włącz pamięć dynamiczną",
        body: "Po włączeniu aplikacja po cichu wyciąga ważne fakty z Twoich czatów i przywołuje je później, dzięki czemu postacie pamiętają to, co ważne.",
      },
      mode: {
        title: "Wybierz, ile kontroli chcesz mieć",
        body: "Automatycznie wykonuje aktualizacje pamięci w tle, Pytaj najpierw pyta Cię przed zapisaniem, a Ręcznie zostawia wszystko Tobie.",
      },
      preset: {
        title: "Profile ustawiają strojenie",
        body: "Wybierz profil, aby ustawić zanikanie, budżety i progi za jednym razem. Wszystko możesz dopracować w ustawieniach zaawansowanych.",
      },
      embedding: {
        title: "Napędzane małym lokalnym modelem",
        body: "Przywoływanie działa dzięki embeddingom obliczanym na Twoim urządzeniu. Ta sekcja zarządza wersją modelu embeddingów i jego ustawieniami.",
      },
    },
  ...
  editModel: {
    ...
    runtimeFacts: {
      ...
      requestedUbatch: "Żądana mikropartia",
      actualUbatch: "Rzeczywista mikropartia",
      nativeFit: "Dopasowanie parametrów natywnych",
      nativeFitContext: "Kontekst dopasowania natywnego",
      nativeFitGpuLayers: "Warstwy GPU dopasowania natywnego",
      nativeFitMargin: "Margines bezpieczeństwa dopasowania natywnego",
      nativeFitTensorSplit: "Podział tensorów dopasowania natywnego",
      nativeFitError: "Błąd dopasowania natywnego",
      promptCacheHit: "Trafienie pamięci podręcznej promptu",
      promptCacheEntries: "Wpisy pamięci podręcznej promptu",
      promptCacheMemory: "Rozmiar pamięci podręcznej promptu",
      promptCacheEvictions: "Usunięcia z pamięci podręcznej promptu",
      nativePromptSpeed: "Natywna prędkość promptu",
      nativeGenerationSpeed: "Natywna prędkość generowania",
      ...
      thinkingDirective: "Dyrektywa myślenia",
    },
    fields: {
      platform: "Platform",
    ...
    providerPin: {
      action: "Przypnij dostawcę",
      change: "Zmień dostawcę",
      title: "Przypnij dostawcę",
      pinned: "Przypięty dostawca",
      clear: "Użyj automatycznego routingu",
      loading: "Ładowanie dostawców...",
      error: "Nie udało się załadować dostawców.",
      empty: "Brak dostępnych dostawców dla tego modelu.",
      cacheSupported: "Pamięć podręczna",
    ...
    layerPlacement: {
      ...
      multiGpuFixedLayers: "W tym modelu zapisano stałą liczbę warstw GPU ({{layers}}), która nadpisuje inteligentne planowanie, więc dodana VRAM nie zostanie wykorzystana. Zresetuj ją, aby dopasować podział do aktualnego sprzętu.",
      multiGpuFixedLayersReset: "Resetuj do Auto",
      multiGpuGlobalDefaultOn: "Multi-GPU jest włączone w ustawieniach globalnych. Ten model jest dzielony między wybrane GPU.",
      multiGpuPinnedNotice: "Ten model jest przypięty do {{device}} i działa tylko na tym GPU, więc podział multi-GPU jest pomijany.",
  ...
  runtimeDefaults: {
    ...
    reconfigureBodyMulti: "Multi-GPU jest teraz włączone. Zresetuj zapisaną liczbę warstw GPU i nadpisanie pojedynczego GPU dla każdego lokalnego modelu, aby inteligentne planowanie mogło rozdzielić każdy model między wybrane GPU.",
    reconfigureBodySingle: "Multi-GPU jest teraz wyłączone. Skieruj każdy lokalny model na {{gpu}} i zresetuj zapisane liczby warstw, aby planowanie dopasowało każdy model do tej karty.",
    ...
    llamaGpuMinTwo: "Wybierz co najmniej dwa GPU, aby aktywować ładowanie multi-GPU.",
    llamaMultiGpuRequiresTwo: "Wymaga co najmniej dwóch dyskretnych GPU. Zintegrowane GPU nigdy nie są używane.",
    llamaDistributionTitle: "Rozkład",
    llamaDistributionDescription: "Domyślny sposób rozłożenia warstw na wybranych GPU.",
    llamaDistBalanced: "Zrównoważony",
    llamaDistProportional: "Proporcjonalnie do VRAM",
    llamaDistPriority: "Wypełnianie priorytetowe",
    llamaPriorityVramTitle: "Limit VRAM głównego GPU (GB)",
    llamaPriorityVramDescription: "Wypełnij pierwsze GPU do tej ilości VRAM, a następnie przejdź do kolejnych.",
    llamaKvPlacementTitle: "Pamięć podręczna KV",
    llamaKvPlacementDescription: "Gdzie przechowywana jest pamięć podręczna KV kontekstu.",
    llamaKvAuto: "Automatycznie",
    llamaKvSplit: "Podziel wraz z warstwami",
    llamaKvSystemRam: "Pamięć RAM systemu",
    llamaKvPin: "Preferuj główne GPU",
    llamaPinnedGpu: "Główne GPU",
    llamaSingleGpuTitle: "Urządzenie GPU",
    llamaSingleGpuDescription: "Uruchamiaj ten model na jednym konkretnym GPU zamiast na domyślnym urządzeniu.",
    llamaSingleGpuAuto: "Automatycznie",
    llamaSingleGpuAutoDesc: "Pozwól llama.cpp wybrać domyślne GPU.",
    llamaManualPerModelNote: "Ręczną liczbę warstw na każde GPU ustawia się osobno dla każdego modelu w edytorze modeli.",
    llamaMultiGpuInherit: "Dziedzicz",
    llamaMultiGpuSplitHint: "Podziel ten model na wybrane dedykowane GPU. Zintegrowane GPU nigdy nie są używane.",
    llamaCpuLayers: "Warstwy CPU",
    llamaManualAssignHint: "Wybierz GPU powyżej, aby przypisać warstwy.",
    llamaManualSumWarning: "Warstwy GPU + CPU muszą być równe sumie całkowitej",
    llamaManualPlacementBrief: "{{gpu}} warstw na GPU · {{cpu}} na CPU",
    llamaManualPlacementFull: "{{gpu}} na GPU · {{cpu}} na CPU · {{total}} łącznie",
    llamaEstimatedPlacement: "Szacowane: {{breakdown}} · {{total}} warstw na GPU",
    llamaDistBalancedDesc: "Równy podział między wybrane GPU. Przeznaczony dla identycznych kart; wybierz Proporcjonalnie, gdy karty różnią się ilością VRAM.",
    llamaDistProportionalDesc: "Udział każdego GPU zależy od ilości wolnej VRAM. Najlepsze dla różnych kart.",
    llamaDistPriorityDesc: "Zapełnia pierwsze GPU do limitu VRAM, a następnie przechodzi do kolejnego.",
    llamaDistManual: "Ręcznie dla każdego GPU",
    llamaDistManualDesc: "Samodzielnie ustaw dokładną liczbę warstw dla każdego GPU i CPU.",
    llamaKvAutoDesc: "Decyduje środowisko uruchomieniowe. KV pozostaje na GPU, gdy się mieści, w przeciwnym razie w RAM systemowej.",
    llamaKvSplitDesc: "KV cache znajduje się na GPU, podzielony tak samo jak warstwy. Najszybsze, używa VRAM.",
    llamaKvSystemRamDesc: "Trzyma KV cache w RAM systemowej, aby zwolnić VRAM na więcej warstw. Wolniejsza uwaga.",
    llamaKvPinDesc: "Kieruje współdzielone bufory tymczasowe do jednego wybranego głównego GPU. KV cache każdej warstwy pozostaje na GPU tej warstwy.",
    llamaBatchTitle: "Domyślny rozmiar partii promptu",
    llamaBatchDescription: "Maksymalna logiczna partia promptu. Puste pole oznacza 512.",
    llamaUbatchTitle: "Domyślny rozmiar mikropartii promptu",
    llamaUbatchDescription: "Fizyczna partia obliczeniowa używana wewnątrz partii logicznej. Niższe wartości zmniejszają zużycie pamięci.",
  },
  loraSelector: {
    title: "Design LoRA",
  ...
  performance: {
    title: "Wydajność lokalnych LLM",
    subtitle: "Prędkość dekodowania i wykorzystanie kontekstu we wszystkich twoich lokalnych generacjach",
    empty: "Nie zarejestrowano jeszcze żadnych lokalnych generacji. Uruchom model lokalny w czacie, aby zobaczyć wykresy wydajności.",
    refresh: "Odśwież",
    clear: "Wyczyść historię",
    clearConfirmTitle: "Wyczyścić historię wydajności?",
    clearConfirmBody: "Usunie to wszystkie zarejestrowane metryki lokalnych generacji i nie można tego cofnąć.",
    cleared: "Historia wydajności została wyczyszczona",
    stats: {
      runs: "Zarejestrowane przebiegi",
      avgSpeed: "Średnia prędkość dekodowania",
      peakSpeed: "Szczytowa prędkość dekodowania",
      avgTtft: "Średni czas do pierwszego tokenu",
    },
    charts: {
      speedByRun: "Prędkość dekodowania według przebiegu",
      speedByRunSub: "Tokeny na sekundę, od najstarszego do najnowszego",
      speedVsContext: "Prędkość w zależności od rozmiaru kontekstu",
      speedVsContextSub: "Prędkość dekodowania względem długości kontekstu",
      detailTitle: "Szczegóły generacji",
      latestTitle: "Najnowsza generacja, sekunda po sekundzie",
      latestSub: "Prędkość dekodowania i zapełnienie kontekstu podczas ostatniego przebiegu",
      speedAxis: "tok/s",
      contextAxis: "kontekst %",
      legendSpeed: "Prędkość dekodowania (tok/s)",
      legendContext: "Zapełnienie kontekstu (%)",
      runAxis: "Przebieg (od najstarszego do najnowszego)",
      contextSizeAxis: "Rozmiar kontekstu (tokeny)",
      elapsedAxis: "sekundy",
      noSamples: "Dla tej generacji nie zarejestrowano próbek co sekundę.",
    },
    detail: {
      decodeSpeed: "Prędkość dekodowania",
      nativePromptSpeed: "Natywna prędkość promptu",
      nativeGenerationSpeed: "Natywna prędkość generowania",
