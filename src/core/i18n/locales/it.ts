...
export const itMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  settings: {
    ...
    items: {
      ...
      performance: {
        title: "Prestazioni LLM locali",
        subtitle: "Grafici di velocità e contesto",
      },
    },
    groups: {
  ...
  chats: {
    ...
    message: {
      ...
      regenerateMenuTitle: "Rigenera",
      regenerateWithDirection: "Rigenera con indicazioni",
      regenerateWithDirectionDescription: "Descrivi come dovrebbe cambiare la prossima risposta",
      regenerateWithModel: "Rigenera con un modello diverso",
      regenerateWithModelDescription: "Scegli un modello solo per questa risposta",
      regenerateModelPickerTitle: "Rigenera con un modello",
    ...
    companionRelationship: {
      ...
      pointsAboveDefault: "{{count}} punti sopra i valori predefiniti del personaggio",
      pointsBelowDefault: "{{count}} punti sotto i valori predefiniti del personaggio",
    },
    companionUi: {
      relationship: "Relazione",
    ...
    memories: {
      ...
      cycleStatusAria: "Stato del ciclo di memoria",
      nextMemoryCycle: "Prossimo ciclo di memoria",
      cycleWaitingForApproval: "In attesa di approvazione · {{count}} messaggi in coda",
      cycleManualReady: "{{count}} messaggi pronti · esegui manualmente",
      cycleReadyAfterResponse: "Pronto per l'esecuzione dopo la prossima risposta",
      cycleMessagesNeeded: "Servono ancora {{count}} messaggi",
      cycleMessageNeeded: "Serve ancora 1 messaggio",
      cycleMode: "Modalità: {{mode}}",
      cycleModeAuto: "Automatica",
      cycleModeAskFirst: "Chiedi prima",
      cycleModeManual: "Manuale",
      conversationMessageCount: "{{count}} messaggi della conversazione",
      lastCycleStatus: "Ultimo ciclo: {{status}}",
      cycleStatusComplete: "completato",
      cycleStatusError: "non riuscito",
      cycleStatusUnknown: "sconosciuto",
      skippedCycleNotice: "Il ciclo precedente di Chiedi prima è stato saltato. I suoi messaggi saranno inclusi nel prossimo ciclo.",
      ...
      branchConversationMessageCount: "{{count}} messaggi in questo ramo",
    },
    widgets: {
      types: {
        divider: {
  ...
  groupChats: {
    list: {
      ...
      deleteConfirmTitle: "Eliminare il gruppo?",
      deleteConfirmMessage: "Sei sicuro di voler eliminare il gruppo \"{{name}}\"? Questo elimina il gruppo e tutte le sue chat.",
      ...
      emptyChatPreview: "Nessun messaggio",
      startFirstChatHint: "Tocca per iniziare la prima chat",
      startingChat: "Avvio della chat...",
      startChatFailed: "Impossibile avviare una nuova chat. Riprova.",
      deleteGroupFailed: "Impossibile eliminare il gruppo. Riprova.",
    ...
    overrides: {
      overriddenLabel: "Sovrascritto per questa chat",
      useGroupDefault: "Usa il valore predefinito del gruppo",
      participantsOverridden: "Partecipanti modificati per questa chat",
      mutedOverridden: "Partecipanti silenziati modificati per questa chat",
    },
    memories: {
      tabMemories: "Ricordi",
      tabPinned: "Fissati",
    ...
    groupSettings: {
      ...
      defaultsHint: "Questi sono i valori predefiniti del gruppo. Le modifiche si applicano alle chat che seguono ancora il valore predefinito del gruppo per un'impostazione. Le chat con una propria sovrascrittura la mantengono.",
    },
    sessionSettings: {
      subtitle: "Gestisci le preferenze della chat di gruppo",
      groupActionsTitle: "Gruppo",
      groupActionsSubtitle: "Questa chat appartiene a {{name}}",
      newChatDesc: "Avvia una nuova chat con i valori predefiniti del gruppo",
      chatHistoryDesc: "Visualizza e gestisci le chat di questo gruppo",
      groupSettingsDesc: "Modifica i valori predefiniti condivisi da tutte le chat",
      overrideHint: "Le impostazioni qui sotto si applicano solo a questa chat. Modificare un'impostazione che segue il valore predefinito del gruppo crea una sovrascrittura per questa chat.",
      enterGroupName: "Inserisci nome del gruppo",
      participant: "partecipante",
      participants: "partecipanti",
      message: "messaggio",
    ...
    page: {
      ...
      requestFailed: "Richiesta della chat di gruppo non riuscita",
    ...
    messageActionsExtra: {
      ...
      branchToCharacter: "Dirama in chat individuale da qui",
      selectCharacterForBranch: "Continua da questo punto in una chat privata con questo personaggio",
    },
    timeAgo: {
      justNow: "Adesso",
      minutesAgo: "{{count}}m fa",
  ...
  characters: {
    ...
    lorebook: {
      ...
      regularExpressionsLabel: "ESPRESSIONI REGOLARI",
      regularExpressionHint: "Inserisci pattern non delimitati come mela|banana. Non racchiudere i pattern tra /.",
      regularExpressionPlaceholder: "es. mela|banana",
      matchType: "Tipo di corrispondenza",
      literalText: "Testo letterale",
      ...
      regularExpression: "Usa espressioni regolari",
    },
    templates: {
      characterNotFound: "Personaggio non trovato",
  ...
  providers: {
    ...
    editor: {
      ...
      comfyWorkflowHelp: "Incolla i workflow in formato API esportati da ComfyUI. Token: %PROMPT%, %NEGATIVE%, %WIDTH%, %HEIGHT%, %STEPS%, %CFG%, %SEED%, %SAMPLER%, %CKPT%, %DENOISE%, %IMAGE_COUNT% e %IMAGE0%, %IMAGE1%, ... per le immagini di riferimento in ordine (%IMAGE% è la prima). Il workflow immagine viene usato quando sono presenti immagini di riferimento.",
      streaming: "Streaming",
      ...
      sprout: "Usa Sprout per verificare l'eseguibilità",
      sproutDesc: "Interroga una sonda hardware Sprout su questo host per verificare quali modelli si adattano alla sua GPU e memoria",
      sproutUrl: "URL di Sprout",
      sproutApiKey: "Chiave API Sprout (opzionale)",
      sproutApiKeyPlaceholder: "Token Bearer dalla console Sprout",
      sproutGet: "Ottieni Sprout su GitHub",
      chatEndpoint: "Endpoint chat",
      resolvedChatUrl: "Le richieste andranno a",
      resolvedChatUrlDuplicate: "\"{{segment}}\" si trova alla fine della Base URL e all'inizio del Chat Endpoint, quindi verrà inviato due volte. Rimuovilo da uno dei due.",
      resolvedModelsUrlDuplicate: "\"{{segment}}\" si trova alla fine della Base URL e all'inizio del Models Endpoint, quindi verrà inviato due volte. Rimuovilo da uno dei due.",
  ...
  hfBrowser: {
    ...
    mobileOllamaTitle: "Connetti un provider Ollama",
    mobileOllamaCta: "Aggiungi provider Ollama",
    ollamaModeNoticeTitle: "Raccomandazioni non disponibili",
    ollamaModeNoticeBody: "Questo modello viene eseguito sull'host remoto, quindi l'app non può stimare l'eseguibilità da sola. Abilita Sprout per questo provider Ollama per sondare la GPU e la memoria dell'host, e i suggerimenti rifletteranno quella macchina.",
    getSprout: "Ottieni Sprout",
    ollamaVisionUnsupported: "La visione non è disponibile per i modelli importati in Ollama, nemmeno con un file mmproj. Esegui questo modello localmente per il supporto delle immagini.",
    modeLlm: "LLM",
    modeImage: "Immagine",
    clearSearch: "Cancella ricerca",
    filters: "Filtri",
  ...
  tour: {
    ...
    hfBrowser: {
      panel: {
        ...
        body: "Tutto qui è calibrato su questa macchina: il verdetto in alto dice se il modello girerà e con quanta scioltezza. Cambia un'impostazione e il verdetto si aggiorna subito.",
      },
      tabs: {
        title: "Due modi per esplorare",
        body: "Impostazioni consigliate sceglie e regola un file per te. File disponibili elenca tutti i download del repository se preferisci scegliere a mano.",
      },
      quant: {
  ...
  sessionAdvanced: {
    ...
    samplingMemory: {
      ...
      xtcProbability: "Probabilità XTC",
      xtcProbabilityDesc: "Probabilità di escludere i token più probabili (0 = disattivato). Aumenta la varietà.",
      xtcThreshold: "Soglia XTC",
      xtcThresholdDesc: "Probabilità minima che un token deve avere per essere rimosso da XTC.",
      seed: "Seed",
  ...
  samplerOrder: {
    ...
    stages: {
      ...
      xtc: {
        label: "XTC",
        desc: "Escludi le scelte principali — scarta i token ad alta probabilità per più varietà.",
      },
      temp: {
        label: "Temperature",
  ...
  installedModels: {
    ...
    confirm: {
      inUseTitle: "Il file è in uso",
      inUseBody: "Questo file è usato da: {{models}}. Eliminandolo, quelle configurazioni smetteranno di funzionare finché non scegli un altro file.",
      inUseGlobalDefaults: "Impostazioni globali",
  ...
  editModel: {
    ...
    runtimeFacts: {
      ...
      requestedUbatch: "Microbatch richiesto",
      actualUbatch: "Microbatch effettivo",
      nativeFit: "Adattamento nativo dei parametri",
      nativeFitContext: "Contesto dell'adattamento nativo",
      nativeFitGpuLayers: "Layer GPU dell'adattamento nativo",
      nativeFitMargin: "Margine di sicurezza dell'adattamento nativo",
      nativeFitTensorSplit: "Tensor split dell'adattamento nativo",
      nativeFitError: "Errore dell'adattamento nativo",
      promptCacheHit: "Corrispondenza prompt cache",
      promptCacheEntries: "Voci prompt cache",
      promptCacheMemory: "Memoria prompt cache",
      promptCacheEvictions: "Espulsioni prompt cache",
      nativePromptSpeed: "Velocità prompt nativa",
      nativeGenerationSpeed: "Velocità generazione nativa",
      nativePromptTime: "Tempo prompt nativo",
      nativeGenerationTime: "Tempo generazione nativo",
      appGenerationOverhead: "Overhead di generazione dell'app",
      thinkingMode: "Modalità di pensiero",
      thinkingDirective: "Direttiva di pensiero",
    },
    fields: {
      platform: "Platform",
    ...
    providerPin: {
      action: "Fissa un provider",
      change: "Cambia provider",
      title: "Fissa un provider",
      pinned: "Provider fissato",
      clear: "Usa instradamento automatico",
      loading: "Caricamento provider...",
      error: "Impossibile caricare i provider.",
      empty: "Nessun provider è attualmente disponibile per questo modello.",
    ...
    layerPlacement: {
      ...
      multiGpuGlobalDefaultOn: "Il multi-GPU è attivo dalle impostazioni globali. Questo modello viene suddiviso tra le GPU selezionate.",
      multiGpuPinnedNotice: "Questo modello è fissato su {{device}} e gira solo su quella GPU, quindi la suddivisione multi-GPU viene saltata.",
      ...
      ubatchSizeDescription: "Blocco di calcolo fisico",
    },
    llamaSampler: {
  ...
  runtimeDefaults: {
    ...
    llamaMultiGpuDescription: "Disattivato per impostazione predefinita. Attivalo solo quando vuoi che llama.cpp distribuisca un modello tra le GPU selezionate.",
    llamaMultiGpuEnabled: "Attivato",
    llamaMultiGpuDisabled: "Disattivato",
    reconfigureTitle: "Riconfigurare tutti i modelli?",
    reconfigureBodyMulti: "Il multi-GPU è ora attivo. Reimposta il numero di layer GPU salvato e l'assegnazione a GPU singola di ogni modello locale, così la pianificazione intelligente può distribuire ogni modello tra le GPU selezionate.",
    reconfigureBodySingle: "Il multi-GPU è ora disattivato. Assegna ogni modello locale a {{gpu}} e reimposta i numeri di layer salvati, così la pianificazione dimensiona ogni modello per quella scheda.",
    reconfigureConfirm: "Riconfigura {{count}} modelli",
    reconfigureRunning: "Riconfigurazione dei modelli...",
    reconfigureSkip: "Mantieni le impostazioni attuali dei modelli",
    reconfigureDone: "Modelli riconfigurati",
    reconfigureDoneBody: "{{count}} modelli locali ora seguono la nuova configurazione GPU.",
    llamaGpuDevicesTitle: "Dispositivi GPU",
    llamaGpuDevicesDescription: "Seleziona due o più dispositivi GPU dedicati. I dispositivi integrati e CPU non vengono mai mostrati qui.",
    llamaGpuNone: "Nessuna GPU dedicata rilevata da llama.cpp.",
    llamaGpuMemory: "{{free}} / {{total}} GB liberi",
    llamaGpuMinTwo: "Seleziona almeno due GPU per attivare il caricamento multi-GPU.",
    llamaMultiGpuRequiresTwo: "Richiede due o più GPU dedicate. Le GPU integrate non vengono mai utilizzate.",
    llamaDistributionTitle: "Distribuzione",
    llamaDistributionDescription: "Modo predefinito di distribuire i livelli tra le GPU selezionate.",
    llamaDistBalanced: "Bilanciata",
    llamaDistProportional: "Proporzionale alla VRAM",
    llamaDistPriority: "Riempimento per priorità",
    llamaPriorityVramTitle: "Limite di VRAM della GPU principale (GB)",
    llamaPriorityVramDescription: "Riempi la prima GPU fino a questa quantità di VRAM, poi trabocca sulle altre.",
    llamaKvPlacementTitle: "Cache KV",
    llamaKvPlacementDescription: "Dove viene archiviata la cache KV del contesto.",
    llamaKvAuto: "Automatico",
    llamaKvSplit: "Dividi con i livelli",
    llamaKvSystemRam: "RAM di sistema",
    llamaKvPin: "Preferisci la GPU principale",
    llamaPinnedGpu: "GPU principale",
    llamaSingleGpuTitle: "Dispositivo GPU",
    llamaSingleGpuDescription: "Esegui questo modello su una GPU specifica invece che sul dispositivo predefinito.",
    llamaSingleGpuAuto: "Automatico",
    llamaSingleGpuAutoDesc: "Lascia che llama.cpp scelga la GPU predefinita.",
    llamaManualPerModelNote: "I conteggi manuali dei livelli per GPU vengono impostati per modello nell'editor dei modelli.",
    llamaMultiGpuInherit: "Eredita",
    llamaMultiGpuSplitHint: "Distribuisci questo modello sulle GPU dedicate selezionate. Le GPU integrate non vengono mai usate.",
    llamaCpuLayers: "Livelli CPU",
    llamaManualAssignHint: "Seleziona le GPU sopra per assegnare i livelli.",
    llamaManualSumWarning: "I livelli GPU + CPU devono essere uguali al totale",
    llamaManualPlacementBrief: "{{gpu}} livelli su GPU · {{cpu}} su CPU",
    llamaManualPlacementFull: "{{gpu}} su GPU · {{cpu}} su CPU · {{total}} in totale",
    llamaEstimatedPlacement: "Stimato: {{breakdown}} · {{total}} livelli su GPU",
    llamaDistBalancedDesc: "Suddivisione uniforme tra le GPU selezionate. Pensata per schede identiche; scegli Proporzionale se la VRAM differisce.",
    ...
    llamaDistManual: "Manuale per GPU",
    llamaDistManualDesc: "Imposta tu stesso il numero esatto di layer per ogni GPU e la CPU.",
    ...
    llamaKvPinDesc: "Indirizza i buffer temporanei condivisi su una GPU principale scelta. La cache KV di ogni livello resta sulla GPU di quel livello.",
    llamaBatchTitle: "Dimensione batch prompt",
    llamaBatchDescription: "Batch logico massimo del prompt. Vuoto usa 512.",
    llamaUbatchTitle: "Dimensione microbatch prompt",
    llamaUbatchDescription: "Batch di calcolo fisico usato all'interno di un batch logico. Valori più bassi riducono l'uso di memoria.",
  },
  loraSelector: {
  ...
  performance: {
    title: "Prestazioni LLM locali",
    subtitle: "Velocità di decodifica e utilizzo del contesto nelle tue generazioni locali",
    empty: "Nessuna generazione locale registrata ancora. Esegui un modello locale in chat per vedere i grafici delle prestazioni.",
    refresh: "Aggiorna",
    clear: "Cancella cronologia",
    clearConfirmTitle: "Cancellare la cronologia delle prestazioni?",
    clearConfirmBody: "Questo rimuove tutte le metriche di generazione locale registrate e non può essere annullato.",
    cleared: "Cronologia delle prestazioni cancellata",
    stats: {
      runs: "Esecuzioni registrate",
      avgSpeed: "Velocità di decodifica media",
      peakSpeed: "Velocità di decodifica massima",
      avgTtft: "Primo token medio",
    },
    charts: {
      speedByRun: "Velocità di decodifica per esecuzione",
      speedByRunSub: "Token al secondo, dal più vecchio al più recente",
      speedVsContext: "Velocità rispetto alla dimensione del contesto",
      speedVsContextSub: "Velocità di decodifica in funzione della lunghezza del contesto",
      detailTitle: "Dettaglio generazione",
      latestTitle: "Ultima generazione, secondo per secondo",
      latestSub: "Velocità di decodifica e riempimento del contesto nell'ultima esecuzione",
      speedAxis: "tok/s",
      contextAxis: "contesto %",
      legendSpeed: "Velocità di decodifica (tok/s)",
      legendContext: "Riempimento contesto (%)",
      runAxis: "Esecuzione (dal più vecchio al più recente)",
      contextSizeAxis: "Dimensione contesto (token)",
      elapsedAxis: "secondi",
      noSamples: "Nessun campione al secondo registrato per questa generazione.",
    },
    detail: {
      decodeSpeed: "Velocità di decodifica",
      nativePromptSpeed: "Velocità prompt nativa",
      nativeGenerationSpeed: "Velocità generazione nativa",
      ...
      totalTokens: "Token totali",
      context: "Finestra di contesto",
      batch: "Batch logico",
      microbatch: "Microbatch",
      backend: "Backend",
      gpuLayers: "Layer GPU",
      kvType: "Cache KV",
      elapsed: "Tempo di generazione",
      nativeGenerationTime: "Calcolo di generazione nativo",
      appOverhead: "Overhead dell'app",
      finishReason: "Motivo di fine",
      modelSize: "Dimensione modello",
    },
    list: {
      title: "Generazioni recenti",
      speed: "{{value}} tok/s",
      ttft: "{{value}} ms",
      unknownModel: "Modello sconosciuto",
    },
