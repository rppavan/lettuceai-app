...
export const trMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  hfBrowser: {
    ...
    ollamaModeNoticeBody: "Uzak bir Ollama sağlayıcısı seçiliyken donanım farkındalığına sahip öneriler devre dışı kalır. Model, uygulamanın çalıştırılabilirlik tahmini yapmak için inceleyemediği ana makinenin donanımında çalışacaktır.",
    modeLlm: "LLM",
    modeImage: "Görüntü",
    clearSearch: "Aramayı temizle",
    filters: "Filtreler",
