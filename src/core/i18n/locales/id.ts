...
export const idMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  hfBrowser: {
    ...
    ollamaModeNoticeBody: "Saran berbasis perangkat keras dinonaktifkan saat penyedia Ollama jarak jauh dipilih. Model akan berjalan di perangkat keras host, yang tidak dapat diperiksa aplikasi untuk memperkirakan kemampuan jalan.",
    modeLlm: "LLM",
    modeImage: "Gambar",
