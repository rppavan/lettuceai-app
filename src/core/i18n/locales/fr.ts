...
export const frMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  hfBrowser: {
    ...
    ollamaModeNoticeBody: "Les suggestions tenant compte du matériel sont désactivées lorsqu'un fournisseur Ollama distant est sélectionné. Le modèle s'exécutera sur le matériel de l'hôte, que l'application ne peut pas inspecter pour estimer la capacité d'exécution.",
    modeLlm: "LLM",
    modeImage: "Image",
    clearSearch: "Effacer la recherche",
    filters: "Filtres",
