...
export const frMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  chats: {
    ...
    message: {
      ...
      regenerateMenuTitle: "Régénérer",
      regenerateWithDirection: "Régénérer avec une direction",
      regenerateWithDirectionDescription: "Décris comment la prochaine réponse devrait changer",
      regenerateWithModel: "Régénérer avec un autre modèle",
      regenerateWithModelDescription: "Choisis un modèle pour cette réponse uniquement",
      regenerateModelPickerTitle: "Régénérer avec un modèle",
    ...
    companionRelationship: {
      ...
      pointsAboveDefault: "{{count}} points au-dessus de la valeur par défaut du personnage",
      pointsBelowDefault: "{{count}} points en dessous de la valeur par défaut du personnage",
    },
    companionUi: {
      relationship: "Relation",
      milestones: "Jalons",
  ...
  providers: {
    ...
    editor: {
      ...
      resolvedChatUrlDuplicate: "\"{{segment}}\" se trouve à la fin de l'URL de base et au début du point de terminaison de chat, il sera donc envoyé deux fois. Retirez-le de l'un des deux.",
      resolvedModelsUrlDuplicate: "\"{{segment}}\" se trouve à la fin de l'URL de base et au début du point de terminaison des modèles, il sera donc envoyé deux fois. Retirez-le de l'un des deux.",
  ...
  installedModels: {
    ...
    confirm: {
      ...
      inUseBody: "Ce fichier est utilisé par : {{models}}. Le supprimer cassera ces configurations jusqu'à ce que vous choisissiez un autre fichier.",
  ...
  editModel: {
    ...
    runtimeFacts: {
      ...
      requestedUbatch: "Micro-lot demandé",
      actualUbatch: "Micro-lot réel",
      nativeFit: "Ajustement natif des paramètres",
      nativeFitContext: "Contexte d'ajustement natif",
      nativeFitGpuLayers: "Couches GPU d'ajustement natif",
      nativeFitMargin: "Marge de sécurité de l'ajustement natif",
      nativeFitTensorSplit: "Répartition des tenseurs d'ajustement natif",
      nativeFitError: "Erreur d'ajustement natif",
      promptCacheHit: "Succès du cache de prompt",
      promptCacheEntries: "Entrées du cache de prompt",
      promptCacheMemory: "Mémoire du cache de prompt",
      promptCacheEvictions: "Évictions du cache de prompt",
      nativePromptSpeed: "Vitesse native du prompt",
      nativeGenerationSpeed: "Vitesse native de génération",
      nativePromptTime: "Temps natif du prompt",
      nativeGenerationTime: "Temps natif de génération",
      appGenerationOverhead: "Surcharge de génération de l'application",
      thinkingMode: "Mode réflexion",
      thinkingDirective: "Directive de réflexion",
    },
    modelSource: {
    ...
    layerPlacement: {
      ...
      multiGpuGlobalDefaultOn: "Le multi-GPU est activé via les réglages globaux. Ce modèle est réparti entre les GPU sélectionnés.",
      multiGpuPinnedNotice: "Ce modèle est épinglé sur {{device}} et s'exécute uniquement sur ce GPU, la répartition multi-GPU est donc ignorée.",
  ...
  tour: {
    ...
    hfBrowser: {
      panel: {
        ...
        body: "Tout ici est calibré pour cette machine : le verdict en haut indique si le modèle tournera, et avec quelle aisance. Modifiez un réglage et le verdict se met à jour en direct.",
      },
      tabs: {
        title: "Deux façons de parcourir",
        body: "Réglages recommandés choisit et ajuste un fichier pour vous. Fichiers disponibles liste tous les téléchargements du dépôt si vous préférez choisir vous-même.",
      },
      quant: {
  ...
  runtimeDefaults: {
    ...
    llamaUbatchDescription: "Lot de calcul physique utilisé à l'intérieur d'un lot logique. Des valeurs plus basses réduisent l'utilisation de la mémoire.",
  },
  loraSelector: {
  ...
  performance: {
    title: "Performance des LLM locaux",
    subtitle: "Vitesse de décodage et utilisation du contexte pour vos générations locales",
    empty: "Aucune génération locale enregistrée pour l'instant. Exécutez un modèle local dans une discussion pour voir les graphiques de performance.",
    refresh: "Actualiser",
    clear: "Effacer l'historique",
    clearConfirmTitle: "Effacer l'historique de performance ?",
    clearConfirmBody: "Cela supprime toutes les métriques de génération locale enregistrées et cette action est irréversible.",
    cleared: "Historique de performance effacé",
    stats: {
      runs: "Exécutions enregistrées",
      avgSpeed: "Vitesse de décodage moy.",
      peakSpeed: "Vitesse de décodage max.",
      avgTtft: "Premier token moy.",
    },
    charts: {
      speedByRun: "Vitesse de décodage par exécution",
      speedByRunSub: "Tokens par seconde, du plus ancien au plus récent",
      speedVsContext: "Vitesse par rapport à la taille du contexte",
      speedVsContextSub: "Vitesse de décodage en fonction de la longueur du contexte",
      detailTitle: "Détail de la génération",
      latestTitle: "Dernière génération, seconde par seconde",
      latestSub: "Vitesse de décodage et remplissage du contexte sur la dernière exécution",
      speedAxis: "tok/s",
      contextAxis: "contexte %",
      legendSpeed: "Vitesse de décodage (tok/s)",
      legendContext: "Remplissage du contexte (%)",
      runAxis: "Exécution (du plus ancien au plus récent)",
      contextSizeAxis: "Taille du contexte (tokens)",
      elapsedAxis: "secondes",
      noSamples: "Aucun échantillon par seconde n'a été enregistré pour cette génération.",
    },
    detail: {
      decodeSpeed: "Vitesse de décodage",
      nativePromptSpeed: "Vitesse native du prompt",
      nativeGenerationSpeed: "Vitesse native de génération",
      ...
      gpuLayers: "Couches GPU",
      kvType: "Cache KV",
      elapsed: "Temps de génération",
      nativeGenerationTime: "Calcul natif de génération",
