...
export const ruMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  settings: {
    ...
    items: {
      ...
      performance: {
        title: "Производительность локальных LLM",
        subtitle: "Графики скорости и контекста",
      },
    },
    groups: {
  ...
  chats: {
    ...
    message: {
      ...
      regenerateMenuTitle: "Перегенерировать",
      regenerateWithDirection: "Перегенерировать с указанием",
      regenerateWithDirectionDescription: "Опишите, как должен измениться следующий ответ",
      regenerateWithModel: "Перегенерировать с другой моделью",
      regenerateWithModelDescription: "Выберите модель только для этого ответа",
      regenerateModelPickerTitle: "Перегенерация с моделью",
    ...
    companionRelationship: {
      ...
      pointsAboveDefault: "{{count}} очков выше значения персонажа по умолчанию",
      pointsBelowDefault: "{{count}} очков ниже значения персонажа по умолчанию",
    },
    companionUi: {
      relationship: "Отношения",
      milestones: "Вехи",
    ...
    memories: {
      ...
      cycleStatusAria: "Статус цикла памяти",
      nextMemoryCycle: "Следующий цикл памяти",
      cycleWaitingForApproval: "Ожидание подтверждения · {{count}} сообщений в очереди",
      cycleManualReady: "{{count}} сообщений готово · запустите вручную",
      cycleReadyAfterResponse: "Готово к запуску после следующего ответа",
      cycleMessagesNeeded: "Нужно ещё {{count}} сообщений",
      cycleMessageNeeded: "Нужно ещё 1 сообщение",
      cycleMode: "Режим: {{mode}}",
      cycleModeAuto: "Автоматически",
      cycleModeAskFirst: "Спрашивать сначала",
      cycleModeManual: "Вручную",
      conversationMessageCount: "{{count}} сообщений разговора",
      lastCycleStatus: "Последний цикл: {{status}}",
      cycleStatusComplete: "завершён",
      cycleStatusError: "не удался",
      cycleStatusUnknown: "неизвестно",
      skippedCycleNotice: "Предыдущий цикл в режиме Спрашивать сначала был пропущен. Его сообщения будут включены в следующий цикл.",
      ...
      branchConversationMessageCount: "{{count}} сообщений в этой ветке",
    },
    widgets: {
      types: {
        divider: {
  ...
  groupChats: {
    list: {
      ...
      deleteConfirmMessage: "Вы уверены, что хотите удалить группу \"{{name}}\"? Это удалит группу и все её чаты.",
    ...
    overrides: {
      overriddenLabel: "Переопределено для этого чата",
      useGroupDefault: "Использовать значение группы",
      participantsOverridden: "Участники изменены для этого чата",
      mutedOverridden: "Заглушённые участники изменены для этого чата",
    },
    memories: {
    ...
    groupSettings: {
      ...
      defaultsHint: "Это настройки группы по умолчанию. Изменения применяются к чатам, которые всё ещё следуют значению группы для настройки. Чаты со своим переопределением сохраняют его.",
    },
    sessionSettings: {
      subtitle: "Управление настройками группового чата",
      groupActionsTitle: "Группа",
      groupActionsSubtitle: "Этот чат принадлежит группе {{name}}",
      newChatDesc: "Начать новый чат с настройками группы по умолчанию",
      chatHistoryDesc: "Просмотр и управление чатами этой группы",
      groupSettingsDesc: "Редактировать общие настройки для всех чатов",
      overrideHint: "Настройки ниже применяются только к этому чату. Изменение настройки, следующей значению группы, создаёт переопределение для этого чата.",
      enterGroupName: "Введите название группы",
      participant: "участник",
      participants: "участников",
      message: "сообщение",
  ...
  providers: {
    ...
    editor: {
      ...
      sprout: "Использовать Sprout для проверки запускаемости",
      sproutDesc: "Запросить аппаратный зонд Sprout на этом хосте, чтобы проверить, какие модели подходят для его GPU и памяти",
      sproutUrl: "URL Sprout",
      sproutApiKey: "Ключ API Sprout (необязательно)",
      ...
      resolvedChatUrlDuplicate: "\"{{segment}}\" находится в конце Base URL и в начале Chat Endpoint, поэтому будет отправлен дважды. Уберите его из одного из полей.",
      resolvedModelsUrlDuplicate: "\"{{segment}}\" находится в конце Base URL и в начале Models Endpoint, поэтому будет отправлен дважды. Уберите его из одного из полей.",
  ...
  installedModels: {
    ...
    confirm: {
      ...
      inUseBody: "Этот файл используется: {{models}}. После удаления эти настройки перестанут работать, пока вы не выберете другой файл.",
  ...
  editModel: {
    ...
    runtimeFacts: {
      ...
      promptTemplate: "Шаблон промпта",
      requestedUbatch: "Запрошенный микропакет",
      actualUbatch: "Фактический микропакет",
      nativeFit: "Нативная подгонка параметров",
      nativeFitContext: "Контекст нативной подгонки",
      nativeFitGpuLayers: "GPU-слои нативной подгонки",
      nativeFitMargin: "Запас надёжности нативной подгонки",
      nativeFitTensorSplit: "Разделение тензоров нативной подгонки",
      nativeFitError: "Ошибка нативной подгонки",
      promptCacheHit: "Попадание в кеш промпта",
      promptCacheEntries: "Записи кеша промпта",
      promptCacheMemory: "Память кеша промпта",
      promptCacheEvictions: "Вытеснения из кеша промпта",
      nativePromptSpeed: "Нативная скорость обработки промпта",
      nativeGenerationSpeed: "Нативная скорость генерации",
      nativePromptTime: "Нативное время обработки промпта",
      nativeGenerationTime: "Нативное время генерации",
      appGenerationOverhead: "Накладные расходы приложения на генерацию",
      thinkingMode: "Режим мышления",
      thinkingDirective: "Директива режима мышления",
    },
    fields: {
      platform: "Платформа",
    ...
    providerPin: {
      action: "Закрепить провайдера",
      change: "Сменить провайдера",
      title: "Закрепить провайдера",
      pinned: "Закреплённый провайдер",
      clear: "Использовать автоматическую маршрутизацию",
      loading: "Загрузка провайдеров...",
      error: "Не удалось загрузить провайдеров.",
      empty: "Для этой модели сейчас нет доступных провайдеров.",
      cacheSupported: "Кэширование",
    ...
    layerPlacement: {
      ...
      multiGpuFixedLayers: "Для этой модели сохранено фиксированное количество слоёв GPU ({{layers}}), которое переопределяет умное планирование, поэтому добавленная VRAM не будет использована. Сбросьте его, чтобы рассчитать разделение исходя из текущего оборудования.",
      multiGpuFixedLayersReset: "Сбросить на Авто",
      multiGpuGlobalDefaultOn: "Multi-GPU включён в глобальных настройках. Эта модель распределяется между выбранными GPU.",
      multiGpuPinnedNotice: "Эта модель закреплена за {{device}} и работает только на этом GPU, поэтому распределение по нескольким GPU пропускается.",
      ...
      ubatchSize: "Размер микропакета",
      ubatchSizeDescription: "Физический вычислительный пакет",
    },
    llamaSampler: {
  ...
  hfBrowser: {
    ...
    ollamaVisionUnsupported: "Обработка изображений недоступна для моделей, импортированных в Ollama, даже при наличии файла mmproj. Запустите эту модель локально для поддержки изображений.",
    modeLlm: "LLM",
  ...
  tour: {
    editModelLlama: {
      context: {
        title: "Выберите, сколько контекста использовать",
        body: "Больший контекст означает более долгую память в разговоре, но он быстро съедает VRAM. Авто подбирает размер под ваше железо, а вы всегда можете настроить его сами.",
      },
      presets: {
        title: "Пресеты настроят всё за вас",
        body: "Сбалансированный, Пропускная способность, Экономия VRAM, CPU + RAM. Одно касание задаёт разумные значения для всего ниже, и потом вы всё ещё можете их подправить.",
      },
      gpu: {
        title: "Здесь живёт выгрузка на GPU",
        body: "Авто планирует слои исходя из свободного VRAM. Если у вас больше одного GPU, здесь можно разделить модель между картами или следовать глобальному значению из настроек.",
      },
      report: {
        title: "Посмотрите, что произошло на самом деле",
        body: "После каждой загрузки этот отчёт показывает, что реально работало: слои на GPU, использованный контекст, любые запасные варианты. Если что-то кажется медленным, сначала загляните сюда.",
      },
    },
    runtimeDefaults: {
      storage: {
        title: "Ваши модели живут здесь",
        body: "В этой папке хранятся все скачанные файлы моделей. Вы можете перенести её на другой диск, когда закончится место.",
      },
      llama: {
        title: "Значения по умолчанию для всех локальных моделей",
        body: "Контекст, KV cache и поведение GPU, заданные здесь, применяются ко всем локальным моделям. Любая модель может переопределить их в своём редакторе.",
      },
      multiGpu: {
        title: "Разделяйте модели между GPU",
        body: "Если у вас две или больше видеокарт, включите это, чтобы распределить слои между ними. Модели с настройкой Наследовать автоматически следуют этому переключателю.",
      },
    },
    hfBrowser: {
      panel: {
        title: "Ваш персональный отчёт совместимости",
        body: "Всё здесь рассчитано под эту машину: вердикт сверху показывает, запустится ли модель и насколько комфортно. Измените любую настройку, и вердикт обновится сразу.",
      },
      tabs: {
        title: "Два способа просмотра",
        body: "Рекомендуемые настройки сами подбирают и настраивают файл. Доступные файлы показывают все загрузки репозитория, если хотите выбрать вручную.",
      },
      quant: {
        title: "Выберите квантизацию",
        body: "Меньшие кванты используют меньше памяти, но немного теряют в качестве. Оценка рядом с каждым файлом показывает, насколько хорошо он подходит вашему железу.",
      },
      context: {
        title: "Контекст тоже стоит памяти",
        body: "Дело не только в файле модели: каждому токену контекста тоже нужно место. Этот ползунок показывает, как далеко можно зайти на вашей машине.",
      },
      offload: {
        title: "Где должна работать модель?",
        body: "Авто выбирает за вас. GPU будет самым быстрым, если модель помещается, CPU работает медленно, но надёжно, а Смешанный делит нагрузку. Позже это можно изменить в редакторе модели.",
      },
      kvLocation: {
        title: "Где живёт кэш разговора",
        body: "Держать KV cache в VRAM быстрее всего. Перенос в RAM освобождает GPU под больше слоёв, когда места впритык.",
      },
    },
    groupChatDetail: {
      title: {
        title: "Настройки группы скрываются за названием",
        body: "Нажмите на название группы, чтобы управлять участниками, выбрать способ выбора следующего говорящего и заглушить персонажей, которым пора отдохнуть.",
      },
      participants: {
        title: "Все, кто в комнате",
        body: "Это персонажи этой группы. Нажмите, чтобы добавить, убрать или изменить порядок участников разговора.",
      },
      memory: {
        title: "Группа помнит вместе",
        body: "Воспоминания группы общие для всего разговора. Нажмите на мозг, чтобы посмотреть, закрепить или почистить то, что знает группа.",
      },
      composer: {
        title: "Скажите что-нибудь",
        body: "Введите сообщение здесь. Кто ответит следующим, зависит от выбора говорящего, который вы задали в настройках группы.",
      },
    },
    dynamicMemory: {
      enable: {
        title: "Включите динамическую память",
        body: "Когда включено, приложение незаметно извлекает важные факты из ваших чатов и вспоминает их позже, чтобы персонажи помнили то, что важно.",
      },
      mode: {
        title: "Выберите, сколько контроля вам нужно",
        body: "Автоматически выполняет обновления памяти в фоне, Спрашивать сначала уточняет у вас перед сохранением, а Вручную оставляет всё вам.",
      },
      preset: {
        title: "Профили задают настройку",
        body: "Выберите профиль, чтобы задать затухание, бюджеты и пороги за один раз. Всё можно тонко настроить в расширенных настройках.",
      },
      embedding: {
        title: "Работает на небольшой локальной модели",
        body: "Припоминание работает через эмбеддинги, вычисляемые на вашем устройстве. Этот раздел управляет версией модели эмбеддингов и её настройками.",
      },
    },
  ...
  runtimeDefaults: {
    ...
    llamaMultiGpuTitle: "Несколько GPU",
    ...
    reconfigureBodyMulti: "Несколько GPU теперь включено. Сбросьте сохранённое количество слоёв GPU и переопределение одиночного GPU для каждой локальной модели, чтобы умное планирование могло распределить каждую модель между выбранными GPU.",
    reconfigureBodySingle: "Несколько GPU теперь отключено. Направьте все локальные модели на {{gpu}} и сбросьте сохранённое количество слоёв, чтобы планирование рассчитало каждую модель под эту карту.",
    ...
    llamaGpuMemory: "{{free}} / {{total}} GB свободно",
    llamaGpuMinTwo: "Выберите хотя бы два GPU, чтобы активировать загрузку на нескольких GPU.",
    llamaMultiGpuRequiresTwo: "Требуется два или более дискретных GPU. Встроенные GPU никогда не используются.",
    llamaDistributionTitle: "Распределение",
    llamaDistributionDescription: "Способ распределения слоёв между выбранными GPU по умолчанию.",
    llamaDistBalanced: "Сбалансированное",
    llamaDistProportional: "Пропорционально VRAM",
    llamaDistPriority: "Приоритетное заполнение",
    llamaPriorityVramTitle: "Лимит VRAM основного GPU (GB)",
    llamaPriorityVramDescription: "Заполняйте первый GPU до этого объёма VRAM, затем переходите к остальным.",
    llamaKvPlacementTitle: "Кэш KV",
    llamaKvPlacementDescription: "Где хранится кэш KV контекста.",
    llamaKvAuto: "Авто",
    llamaKvSplit: "Распределять вместе со слоями",
    llamaKvSystemRam: "Системная RAM",
    llamaKvPin: "Предпочитать основной GPU",
    llamaPinnedGpu: "Основной GPU",
    llamaSingleGpuTitle: "Устройство GPU",
    llamaSingleGpuDescription: "Запускать эту модель на одном конкретном GPU вместо устройства по умолчанию.",
    llamaSingleGpuAuto: "Авто",
    llamaSingleGpuAutoDesc: "Позволить llama.cpp выбрать GPU по умолчанию.",
    llamaManualPerModelNote: "Ручное количество слоёв для каждого GPU задаётся отдельно для каждой модели в редакторе моделей.",
    llamaMultiGpuInherit: "Наследовать",
    llamaMultiGpuSplitHint: "Распределить эту модель между выбранными дискретными GPU. Встроенные GPU никогда не используются.",
    llamaCpuLayers: "Слои CPU",
    llamaManualAssignHint: "Выберите GPU выше, чтобы назначить слои.",
    llamaManualSumWarning: "Сумма слоёв GPU и CPU должна равняться общему количеству",
    llamaManualPlacementBrief: "{{gpu}} слоёв на GPU · {{cpu}} на CPU",
    llamaManualPlacementFull: "{{gpu}} на GPU · {{cpu}} на CPU · всего {{total}}",
    llamaEstimatedPlacement: "Оценка: {{breakdown}} · {{total}} слоёв на GPU",
    llamaDistBalancedDesc: "Равное распределение между выбранными GPU. Рассчитано на одинаковые карты; если объём VRAM различается, выберите «Пропорционально VRAM».",
    ...
    llamaDistManual: "Вручную для каждого GPU",
    llamaDistManualDesc: "Задайте точное количество слоёв для каждого GPU и CPU самостоятельно.",
    ...
    llamaKvPinDesc: "Направляет общие временные буферы на один выбранный основной GPU. KV-кэш каждого слоя остаётся на GPU этого слоя.",
    llamaBatchTitle: "Размер пакета промпта",
    llamaBatchDescription: "Максимальный логический пакет промпта. Пусто = 512.",
    llamaUbatchTitle: "Размер микропакета промпта",
    llamaUbatchDescription: "Физический вычислительный пакет внутри логического пакета. Меньшие значения снижают расход памяти.",
  },
  loraSelector: {
    title: "Дизайн LoRA",
  ...
  performance: {
    title: "Производительность локальных LLM",
    subtitle: "Скорость декодирования и использование контекста в ваших локальных генерациях",
    empty: "Пока нет записанных локальных генераций. Запустите локальную модель в чате, чтобы увидеть графики производительности.",
    refresh: "Обновить",
    clear: "Очистить историю",
    clearConfirmTitle: "Очистить историю производительности?",
    clearConfirmBody: "Это удалит все записанные метрики локальных генераций, действие необратимо.",
    cleared: "История производительности очищена",
    stats: {
      runs: "Записано запусков",
      avgSpeed: "Средняя скорость декодирования",
      peakSpeed: "Пиковая скорость декодирования",
      avgTtft: "Среднее время до первого токена",
    },
    charts: {
      speedByRun: "Скорость декодирования по запускам",
      speedByRunSub: "Токенов в секунду, от старых к новым",
      speedVsContext: "Скорость и размер контекста",
      speedVsContextSub: "Скорость декодирования в зависимости от длины контекста",
      detailTitle: "Детали генерации",
      latestTitle: "Последняя генерация посекундно",
      latestSub: "Скорость декодирования и заполнение контекста за последний запуск",
      speedAxis: "tok/s",
      contextAxis: "контекст, %",
      legendSpeed: "Скорость декодирования (tok/s)",
      legendContext: "Заполнение контекста (%)",
      runAxis: "Запуск (от старых к новым)",
      contextSizeAxis: "Размер контекста (токены)",
      elapsedAxis: "секунды",
      noSamples: "Для этой генерации не записано посекундных замеров.",
    },
    detail: {
      decodeSpeed: "Скорость декодирования",
      nativePromptSpeed: "Нативная скорость обработки промпта",
      nativeGenerationSpeed: "Нативная скорость генерации",
      firstToken: "Первый токен",
      promptTokens: "Токены промпта",
      ...
      totalTokens: "Всего токенов",
      context: "Окно контекста",
      batch: "Логический пакет",
      microbatch: "Микропакет",
      backend: "Бэкенд",
      gpuLayers: "GPU-слои",
      kvType: "KV-кеш",
      elapsed: "Время генерации",
      nativeGenerationTime: "Нативные вычисления генерации",
      appOverhead: "Накладные расходы приложения",
      finishReason: "Причина завершения",
      modelSize: "Размер модели",
    },
    list: {
      title: "Недавние генерации",
      speed: "{{value}} tok/s",
      ttft: "{{value}} мс",
      unknownModel: "Неизвестная модель",
    },
