  ...
  tour: {
    ...
    hfBrowser: {
      panel: {
        ...
        body:
          "Όλα εδώ είναι προσαρμοσμένα σε αυτό το μηχάνημα: η ετυμηγορία επάνω δείχνει αν το μοντέλο θα τρέξει και πόσο άνετα. Άλλαξε οποιαδήποτε ρύθμιση και η ετυμηγορία ενημερώνεται άμεσα.",
      },
      tabs: {
        title: "Δύο τρόποι περιήγησης",
        body:
          "Οι Προτεινόμενες ρυθμίσεις επιλέγουν και ρυθμίζουν ένα αρχείο για σένα. Τα Διαθέσιμα αρχεία δείχνουν όλες τις λήψεις του αποθετηρίου, αν προτιμάς να διαλέξεις μόνος σου.",
      },
      quant: {
