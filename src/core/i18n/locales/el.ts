...
export const elMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  settings: {
    ...
    items: {
      ...
      performance: {
        title: "Απόδοση Τοπικού LLM",
        subtitle: "Γραφήματα ταχύτητας & πλαισίου",
      },
    },
    groups: {
  ...
  chats: {
    ...
    message: {
      ...
      regenerateMenuTitle: "Αναδημιουργία",
      regenerateWithDirection: "Αναδημιουργία με κατεύθυνση",
      regenerateWithDirectionDescription: "Περιγράψτε πώς πρέπει να αλλάξει η επόμενη απάντηση",
      regenerateWithModel: "Αναδημιουργία με διαφορετικό μοντέλο",
      regenerateWithModelDescription: "Επιλέξτε ένα μοντέλο μόνο για αυτή την απάντηση",
      regenerateModelPickerTitle: "Αναδημιουργία με μοντέλο",
    ...
    companionRelationship: {
      ...
      pointsAboveDefault: "{{count}} μονάδες πάνω από την προεπιλογή χαρακτήρα",
      pointsBelowDefault: "{{count}} μονάδες κάτω από την προεπιλογή χαρακτήρα",
    },
    companionUi: {
      relationship: "Σχέση",
      milestones: "Ορόσημα",
    ...
    memories: {
      ...
      cycleStatusAria: "Κατάσταση κύκλου μνήμης",
      nextMemoryCycle: "Επόμενος κύκλος μνήμης",
      cycleWaitingForApproval: "Αναμονή έγκρισης · {{count}} μηνύματα σε αναμονή",
      cycleManualReady: "{{count}} μηνύματα έτοιμα · εκτελέστε χειροκίνητα",
      cycleReadyAfterResponse: "Έτοιμο για εκτέλεση μετά την επόμενη απάντηση",
      cycleMessagesNeeded: "Χρειάζονται {{count}} ακόμη μηνύματα",
      cycleMessageNeeded: "Χρειάζεται 1 ακόμη μήνυμα",
      cycleMode: "Λειτουργία: {{mode}}",
      cycleModeAuto: "Αυτόματα",
      cycleModeAskFirst: "Ερώτηση πρώτα",
      cycleModeManual: "Χειροκίνητα",
      conversationMessageCount: "{{count}} μηνύματα συνομιλίας",
      lastCycleStatus: "Τελευταίος κύκλος: {{status}}",
      cycleStatusComplete: "ολοκληρώθηκε",
      cycleStatusError: "απέτυχε",
      cycleStatusUnknown: "άγνωστο",
      skippedCycleNotice: "Ο προηγούμενος κύκλος σε λειτουργία Ερώτηση πρώτα παραλείφθηκε. Τα μηνύματά του θα συμπεριληφθούν στον επόμενο κύκλο.",
      ...
      branchConversationMessageCount: "{{count}} μηνύματα σε αυτή τη διακλάδωση",
    },
    errors: {
  ...
  groupChats: {
    list: {
      ...
      deleteConfirmTitle: "Διαγραφή Ομάδας;",
      deleteConfirmMessage: "Είστε σίγουροι ότι θέλετε να διαγράψετε την ομάδα \"{{name}}\"; Αυτό θα διαγράψει την ομάδα και όλες τις συνομιλίες της.",
    ...
    overrides: {
      overriddenLabel: "Παράκαμψη για αυτή τη συνομιλία",
      useGroupDefault: "Χρήση προεπιλογής ομάδας",
      participantsOverridden: "Οι συμμετέχοντες άλλαξαν για αυτή τη συνομιλία",
      mutedOverridden: "Οι συμμετέχοντες σε σίγαση άλλαξαν για αυτή τη συνομιλία",
    },
    memories: {
    ...
    groupSettings: {
      ...
      defaultsHint: "Αυτές είναι οι προεπιλογές της ομάδας. Οι αλλαγές εφαρμόζονται σε συνομιλίες που εξακολουθούν να ακολουθούν την προεπιλογή της ομάδας για μια ρύθμιση. Οι συνομιλίες με δική τους παράκαμψη τη διατηρούν.",
    },
    sessionSettings: {
      subtitle: "Διαχείριση ρυθμίσεων ομαδικής συνομιλίας",
      groupActionsTitle: "Ομάδα",
      groupActionsSubtitle: "Αυτή η συνομιλία ανήκει στην ομάδα {{name}}",
      newChatDesc: "Ξεκινήστε μια νέα συνομιλία με τις προεπιλογές της ομάδας",
      chatHistoryDesc: "Δείτε και διαχειριστείτε τις συνομιλίες αυτής της ομάδας",
      groupSettingsDesc: "Επεξεργαστείτε τις προεπιλογές που μοιράζονται όλες οι συνομιλίες",
      overrideHint: "Οι παρακάτω ρυθμίσεις ισχύουν μόνο για αυτή τη συνομιλία. Η αλλαγή μιας ρύθμισης που ακολουθεί την προεπιλογή της ομάδας δημιουργεί παράκαμψη για αυτή τη συνομιλία.",
      enterGroupName: "Εισάγετε όνομα ομάδας",
      participant: "συμμετέχων",
      participants: "συμμετέχοντες",
      message: "μήνυμα",
  ...
  providers: {
    ...
    editor: {
      ...
      comfyWorkflowHelp: "Επικολλήστε ροές εργασίας σε μορφή API που έχουν εξαχθεί από το ComfyUI. Tokens: %PROMPT%, %NEGATIVE%, %WIDTH%, %HEIGHT%, %STEPS%, %CFG%, %SEED%, %SAMPLER%, %CKPT%, %DENOISE%, %IMAGE_COUNT% και %IMAGE0%, %IMAGE1%, ... για εικόνες αναφοράς με τη σειρά (%IMAGE% είναι η πρώτη). Η ροή εργασίας εικόνας χρησιμοποιείται όταν υπάρχουν εικόνες αναφοράς.",
      streaming: "Streaming",
      ...
      sprout: "Χρήση του Sprout για έλεγχο δυνατότητας εκτέλεσης",
      sproutDesc: "Υποβάλετε ερώτημα σε έναν αισθητήρα υλικού Sprout σε αυτόν τον κεντρικό υπολογιστή για να ελέγξετε ποια μοντέλα ταιριάζουν στη GPU και τη μνήμη του",
      sproutUrl: "Sprout URL",
      sproutApiKey: "Κλειδί API Sprout (προαιρετικό)",
      ...
      resolvedChatUrlDuplicate: "Το \"{{segment}}\" βρίσκεται στο τέλος του Base URL και στην αρχή του Chat Endpoint, οπότε θα σταλεί δύο φορές. Αφαίρεσέ το από το ένα από τα δύο.",
      resolvedModelsUrlDuplicate: "Το \"{{segment}}\" βρίσκεται στο τέλος του Base URL και στην αρχή του Models Endpoint, οπότε θα σταλεί δύο φορές. Αφαίρεσέ το από το ένα από τα δύο.",
  ...
  installedModels: {
    ...
    confirm: {
      ...
      inUseBody: "Αυτό το αρχείο χρησιμοποιείται από: {{models}}. Αν το διαγράψεις, αυτές οι ρυθμίσεις θα σταματήσουν να λειτουργούν μέχρι να επιλέξεις άλλο αρχείο.",
  ...
  editModel: {
    ...
    runtimeFacts: {
      ...
      requestedUbatch: "Ζητούμενο microbatch",
      actualUbatch: "Πραγματικό microbatch",
      nativeFit: "Εγγενής προσαρμογή παραμέτρων",
      nativeFitContext: "Πλαίσιο εγγενούς προσαρμογής",
      nativeFitGpuLayers: "Επίπεδα GPU εγγενούς προσαρμογής",
      nativeFitMargin: "Περιθώριο ασφαλείας εγγενούς προσαρμογής",
      nativeFitTensorSplit: "Διαχωρισμός τανυστών εγγενούς προσαρμογής",
      nativeFitError: "Σφάλμα εγγενούς προσαρμογής",
      promptCacheHit: "Επιτυχία cache prompt",
      promptCacheEntries: "Καταχωρήσεις cache prompt",
      promptCacheMemory: "Μνήμη cache prompt",
      promptCacheEvictions: "Εξώσεις cache prompt",
      nativePromptSpeed: "Εγγενής ταχύτητα prompt",
      nativeGenerationSpeed: "Εγγενής ταχύτητα παραγωγής",
      nativePromptTime: "Εγγενής χρόνος prompt",
      nativeGenerationTime: "Εγγενής χρόνος παραγωγής",
      appGenerationOverhead: "Επιβάρυνση παραγωγής εφαρμογής",
      thinkingMode: "Λειτουργία σκέψης",
      thinkingDirective: "Οδηγία σκέψης",
    },
    modelSource: {
    ...
    providerPin: {
      action: "Καρφίτσωμα παρόχου",
      change: "Αλλαγή παρόχου",
      title: "Καρφίτσωμα παρόχου",
      pinned: "Καρφιτσωμένος πάροχος",
      clear: "Χρήση αυτόματης δρομολόγησης",
      loading: "Φόρτωση παρόχων...",
      error: "Δεν ήταν δυνατή η φόρτωση των παρόχων.",
      empty: "Δεν υπάρχουν διαθέσιμοι πάροχοι για αυτό το μοντέλο.",
      cacheSupported: "Προσωρινή μνήμη",
    ...
    layerPlacement: {
      ...
      multiGpuFixedLayers: "Ένας σταθερός αριθμός επιπέδων GPU ({{layers}}) είναι αποθηκευμένος σε αυτό το μοντέλο και παρακάμπτει τον έξυπνο σχεδιασμό, επομένως η προστιθέμενη VRAM δεν θα χρησιμοποιηθεί. Επαναφέρετέ τον για να προσαρμοστεί ο διαμοιρασμός στο τρέχον υλικό.",
      multiGpuFixedLayersReset: "Επαναφορά σε Αυτόματο",
      multiGpuGlobalDefaultOn: "Το Multi-GPU είναι ενεργό από τις καθολικές προεπιλογές. Αυτό το μοντέλο κατανέμεται στις επιλεγμένες GPU.",
      multiGpuPinnedNotice: "Αυτό το μοντέλο είναι καρφιτσωμένο στη {{device}} και τρέχει μόνο σε αυτήν την GPU, οπότε η κατανομή σε πολλές GPU παραλείπεται.",
      ...
      ubatchSize: "Μέγεθος Microbatch",
      ubatchSizeDescription: "Φυσική δέσμη υπολογισμού",
    },
    llamaSampler: {
  ...
  hfBrowser: {
    ...
    mobileOllamaTitle: "Συνδέστε έναν πάροχο Ollama",
    mobileOllamaCta: "Προσθήκη παρόχου Ollama",
    ollamaModeNoticeTitle: "Οι προτάσεις δεν είναι διαθέσιμες",
    ollamaModeNoticeBody: "Αυτό το μοντέλο εκτελείται στον απομακρυσμένο κεντρικό υπολογιστή, οπότε η εφαρμογή δεν μπορεί να εκτιμήσει μόνη της τη δυνατότητα εκτέλεσης. Ενεργοποιήστε το Sprout για αυτόν τον πάροχο Ollama ώστε να ελέγξετε τη GPU και τη μνήμη του κεντρικού υπολογιστή, και οι προτάσεις θα αντικατοπτρίζουν αυτό το μηχάνημα.",
    getSprout: "Αποκτήστε το Sprout",
    ollamaVisionUnsupported: "Η όραση δεν είναι διαθέσιμη για μοντέλα που έχουν εισαχθεί στο Ollama, ακόμη και με αρχείο mmproj. Εκτελέστε αυτό το μοντέλο τοπικά για υποστήριξη εικόνων.",
    modeLlm: "LLM",
    modeImage: "Εικόνα",
  ...
  tour: {
    editModelLlama: {
      context: {
        title: "Επιλέξτε πόσο πλαίσιο θα χρησιμοποιείται",
        body: "Μεγαλύτερο πλαίσιο σημαίνει μεγαλύτερη μνήμη στη συνομιλία, αλλά τρώει γρήγορα VRAM. Το Αυτόματο το προσαρμόζει στο υλικό σας, και μπορείτε πάντα να το ρυθμίσετε μόνοι σας.",
      },
      presets: {
        title: "Τα presets κάνουν τη ρύθμιση για εσάς",
        body: "Ισορροπημένο, Απόδοση (Throughput), Εξοικονόμηση VRAM, CPU + RAM. Ένα πάτημα ορίζει λογικές τιμές για όλα τα παρακάτω, και μπορείτε να τις πειράξετε και μετά.",
      },
      gpu: {
        title: "Εδώ ζει το GPU offload",
        body: "Το Αυτόματο σχεδιάζει τα επίπεδα με βάση την ελεύθερη VRAM σας. Με περισσότερες από μία GPU μπορείτε να μοιράσετε το μοντέλο στις κάρτες από εδώ, ή να ακολουθήσετε την καθολική προεπιλογή από τις ρυθμίσεις.",
      },
      report: {
        title: "Δείτε τι έγινε στην πραγματικότητα",
        body: "Μετά από κάθε φόρτωση, αυτή η αναφορά δείχνει τι έτρεξε πραγματικά: επίπεδα στην GPU, πλαίσιο που χρησιμοποιήθηκε, τυχόν fallbacks. Όταν κάτι μοιάζει αργό, κοιτάξτε πρώτα εδώ.",
      },
    },
    runtimeDefaults: {
      storage: {
        title: "Εδώ ζουν τα μοντέλα σας",
        body: "Αυτός ο φάκελος περιέχει κάθε κατεβασμένο αρχείο μοντέλου. Μπορείτε να τον μετακινήσετε σε άλλο δίσκο όποτε σας τελειώνει ο χώρος.",
      },
      llama: {
        title: "Προεπιλογές για κάθε τοπικό μοντέλο",
        body: "Το πλαίσιο, η KV cache και η συμπεριφορά GPU που ορίζετε εδώ ισχύουν για όλα τα τοπικά μοντέλα. Κάθε μοντέλο μπορεί να τα παρακάμψει από τον δικό του επεξεργαστή.",
      },
      multiGpu: {
        title: "Μοιράστε μοντέλα σε πολλές GPU",
        body: "Με δύο ή περισσότερες κάρτες γραφικών, ενεργοποιήστε το για να απλωθούν τα επίπεδα σε αυτές. Τα μοντέλα σε λειτουργία Κληρονόμηση ακολουθούν αυτόν τον διακόπτη αυτόματα.",
      },
    },
    hfBrowser: {
      panel: {
        title: "Η προσωπική σου αναφορά συμβατότητας",
        body: "Όλα εδώ είναι προσαρμοσμένα σε αυτό το μηχάνημα: η ετυμηγορία επάνω δείχνει αν το μοντέλο θα τρέξει και πόσο άνετα. Άλλαξε οποιαδήποτε ρύθμιση και η ετυμηγορία ενημερώνεται άμεσα.",
      },
      tabs: {
        title: "Δύο τρόποι περιήγησης",
        body: "Οι Προτεινόμενες ρυθμίσεις επιλέγουν και ρυθμίζουν ένα αρχείο για σένα. Τα Διαθέσιμα αρχεία δείχνουν όλες τις λήψεις του αποθετηρίου, αν προτιμάς να διαλέξεις μόνος σου.",
      },
      quant: {
        title: "Επιλέξτε μια κβαντοποίηση",
        body: "Τα μικρότερα quants χρησιμοποιούν λιγότερη μνήμη αλλά χάνουν λίγη ποιότητα. Η βαθμολογία δίπλα σε κάθε αρχείο σας δείχνει πόσο καλά ταιριάζει στο υλικό σας.",
      },
      context: {
        title: "Και το πλαίσιο κοστίζει μνήμη",
        body: "Το αρχείο του μοντέλου δεν είναι όλη η ιστορία: κάθε token πλαισίου χρειάζεται επίσης χώρο. Αυτό το ρυθμιστικό δείχνει πόσο μακριά μπορείτε να φτάσετε στο μηχάνημά σας.",
      },
      offload: {
        title: "Πού πρέπει να τρέχει το μοντέλο;",
        body: "Το Αυτόματο επιλέγει για εσάς. Η GPU είναι η ταχύτερη αν χωράει, η CPU είναι ο αργός αλλά ασφαλής δρόμος, και το Μικτό τα μοιράζει. Μπορείτε να το αλλάξετε αργότερα στον επεξεργαστή μοντέλου.",
      },
      kvLocation: {
        title: "Πού ζει η cache της συνομιλίας",
        body: "Το να κρατάτε την KV cache στη VRAM είναι το ταχύτερο. Το να τη στείλετε στη RAM ελευθερώνει την GPU σας για περισσότερα επίπεδα όταν στενεύουν τα πράγματα.",
      },
    },
    groupChatDetail: {
      title: {
        title: "Οι ρυθμίσεις ομάδας κρύβονται πίσω από το όνομα",
        body: "Πατήστε το όνομα της ομάδας για να διαχειριστείτε τους συμμετέχοντες, να επιλέξετε πώς διαλέγεται ο επόμενος ομιλητής και να κάνετε σίγαση σε χαρακτήρες που θέλετε να μείνουν εκτός.",
      },
      participants: {
        title: "Όλοι στο δωμάτιο",
        body: "Αυτοί είναι οι χαρακτήρες αυτής της ομάδας. Πατήστε για να προσθέσετε, να αφαιρέσετε ή να αλλάξετε τη σειρά όσων συμμετέχουν στη συνομιλία.",
      },
      memory: {
        title: "Η ομάδα θυμάται μαζί",
        body: "Οι ομαδικές μνήμες μοιράζονται σε όλη τη συνομιλία. Πατήστε τον εγκέφαλο για να δείτε, να καρφιτσώσετε ή να καθαρίσετε όσα ξέρει η ομάδα.",
      },
      composer: {
        title: "Πείτε κάτι",
        body: "Πληκτρολογήστε το μήνυμά σας εδώ. Το ποιος απαντά μετά εξαρτάται από την επιλογή ομιλητή που ορίσατε στις ρυθμίσεις ομάδας.",
      },
    },
    dynamicMemory: {
      enable: {
        title: "Ενεργοποιήστε τη δυναμική μνήμη",
        body: "Όταν είναι ενεργή, η εφαρμογή εξάγει διακριτικά σημαντικά γεγονότα από τις συνομιλίες σας και τα ανακαλεί αργότερα, ώστε οι χαρακτήρες να θυμούνται ό,τι μετράει.",
      },
      mode: {
        title: "Επιλέξτε πόσο έλεγχο θέλετε",
        body: "Το Αυτόματα εκτελεί τις ενημερώσεις μνήμης στο παρασκήνιο, το Ερώτηση πρώτα σας ρωτά πριν την αποθήκευση, και το Χειροκίνητα τα αφήνει όλα σε εσάς.",
      },
      preset: {
        title: "Τα προφίλ κάνουν τη ρύθμιση",
        body: "Επιλέξτε ένα προφίλ για να ορίσετε φθορά, προϋπολογισμούς και κατώφλια με μία κίνηση. Μπορείτε να ρυθμίσετε τα πάντα λεπτομερώς στις προχωρημένες ρυθμίσεις.",
      },
      embedding: {
        title: "Με τη δύναμη ενός μικρού τοπικού μοντέλου",
        body: "Η ανάκληση λειτουργεί μέσω embeddings που υπολογίζονται στη συσκευή σας. Αυτή η ενότητα διαχειρίζεται την έκδοση του μοντέλου embedding και τις ρυθμίσεις του.",
      },
    },
  ...
  runtimeDefaults: {
    ...
    reconfigureBodyMulti: "Το Multi-GPU είναι πλέον ενεργό. Επαναφέρετε τον αποθηκευμένο αριθμό επιπέδων GPU και την παράκαμψη μονής GPU κάθε τοπικού μοντέλου, ώστε ο έξυπνος σχεδιασμός να μπορεί να κατανείμει κάθε μοντέλο στις επιλεγμένες GPU.",
    reconfigureBodySingle: "Το Multi-GPU είναι πλέον ανενεργό. Κατευθύνετε κάθε τοπικό μοντέλο στην {{gpu}} και επαναφέρετε τους αποθηκευμένους αριθμούς επιπέδων, ώστε ο σχεδιασμός να προσαρμόσει κάθε μοντέλο σε αυτήν την κάρτα.",
    ...
    llamaGpuMemory: "{{free}} / {{total}} GB ελεύθερα",
    llamaGpuMinTwo: "Επιλέξτε τουλάχιστον δύο GPU για να ενεργοποιήσετε τη φόρτωση multi-GPU.",
    llamaMultiGpuRequiresTwo: "Απαιτεί δύο ή περισσότερες διακριτές GPU. Οι ενσωματωμένες GPU δεν χρησιμοποιούνται ποτέ.",
    llamaDistributionTitle: "Κατανομή",
    llamaDistributionDescription: "Προεπιλεγμένος τρόπος κατανομής των επιπέδων στις επιλεγμένες GPU.",
    llamaDistBalanced: "Ισορροπημένη",
    llamaDistProportional: "Αναλογικά με τη VRAM",
    llamaDistPriority: "Πλήρωση κατά προτεραιότητα",
    llamaPriorityVramTitle: "Όριο VRAM κύριας GPU (GB)",
    llamaPriorityVramDescription: "Γεμίστε την πρώτη GPU μέχρι αυτό το ποσό VRAM και μετά συνεχίστε στις υπόλοιπες.",
    llamaKvPlacementTitle: "Κρυφή μνήμη KV",
    llamaKvPlacementDescription: "Πού αποθηκεύεται η κρυφή μνήμη KV του πλαισίου.",
    llamaKvAuto: "Αυτόματο",
    llamaKvSplit: "Διαχωρισμός μαζί με τα επίπεδα",
    llamaKvSystemRam: "RAM συστήματος",
    llamaKvPin: "Προτίμηση κύριας GPU",
    llamaPinnedGpu: "Κύρια GPU",
    llamaSingleGpuTitle: "Συσκευή GPU",
    llamaSingleGpuDescription: "Εκτελέστε αυτό το μοντέλο σε μία συγκεκριμένη GPU αντί για την προεπιλεγμένη συσκευή.",
    llamaSingleGpuAuto: "Αυτόματο",
    llamaSingleGpuAutoDesc: "Αφήστε το llama.cpp να επιλέξει την προεπιλεγμένη GPU.",
    ...
    llamaMultiGpuInherit: "Κληρονόμηση",
    llamaMultiGpuSplitHint: "Διαμοιρασμός αυτού του μοντέλου στις επιλεγμένες αποκλειστικές GPU. Οι ενσωματωμένες GPU δεν χρησιμοποιούνται ποτέ.",
    llamaCpuLayers: "Επίπεδα CPU",
    llamaManualAssignHint: "Επιλέξτε GPU παραπάνω για να αναθέσετε επίπεδα.",
    llamaManualSumWarning: "Τα επίπεδα GPU + CPU πρέπει να ισούνται με το σύνολο",
    llamaManualPlacementBrief: "{{gpu}} επίπεδα σε GPU · {{cpu}} σε CPU",
    llamaManualPlacementFull: "{{gpu}} σε GPU · {{cpu}} σε CPU · {{total}} σύνολο",
    llamaEstimatedPlacement: "Εκτίμηση: {{breakdown}} · {{total}} επίπεδα σε GPU",
    llamaDistBalancedDesc: "Ισόποσος διαμοιρασμός στις επιλεγμένες GPU. Σχεδιασμένο για πανομοιότυπες κάρτες. Αν η VRAM διαφέρει, επιλέξτε Αναλογικά.",
    ...
    llamaDistManual: "Χειροκίνητα ανά GPU",
    llamaDistManualDesc: "Ορίστε μόνοι σας τον ακριβή αριθμό επιπέδων για κάθε GPU και τη CPU.",
    ...
    llamaKvPinDesc: "Δρομολογεί τα κοινά προσωρινά buffer σε μία επιλεγμένη κύρια GPU. Η KV cache κάθε επιπέδου παραμένει στην GPU του συγκεκριμένου επιπέδου.",
    llamaBatchTitle: "Μέγεθος Batch Prompt",
    llamaBatchDescription: "Μέγιστο λογικό batch prompt. Κενό χρησιμοποιεί 512.",
    llamaUbatchTitle: "Μέγεθος Microbatch Prompt",
    llamaUbatchDescription: "Φυσική δέσμη υπολογισμού που χρησιμοποιείται μέσα σε ένα λογικό batch. Χαμηλότερες τιμές μειώνουν τη χρήση μνήμης.",
  },
  loraSelector: {
  ...
  performance: {
    title: "Απόδοση Τοπικού LLM",
    subtitle: "Ταχύτητα αποκωδικοποίησης και χρήση πλαισίου στις τοπικές σας παραγωγές",
    empty: "Δεν έχουν καταγραφεί ακόμα τοπικές παραγωγές. Εκτελέστε ένα τοπικό μοντέλο σε συνομιλία για να δείτε γραφήματα απόδοσης.",
    refresh: "Ανανέωση",
    clear: "Εκκαθάριση ιστορικού",
    clearConfirmTitle: "Εκκαθάριση ιστορικού απόδοσης;",
    clearConfirmBody: "Αυτό αφαιρεί όλες τις καταγεγραμμένες μετρήσεις τοπικής παραγωγής και δεν μπορεί να αναιρεθεί.",
    cleared: "Το ιστορικό απόδοσης εκκαθαρίστηκε",
    stats: {
      runs: "Καταγεγραμμένες εκτελέσεις",
      avgSpeed: "Μέση ταχύτητα αποκωδικοποίησης",
      peakSpeed: "Μέγιστη ταχύτητα αποκωδικοποίησης",
      avgTtft: "Μέσος χρόνος πρώτου token",
    },
    charts: {
      speedByRun: "Ταχύτητα αποκωδικοποίησης ανά εκτέλεση",
      speedByRunSub: "Tokens ανά δευτερόλεπτο, από την παλαιότερη στη νεότερη",
      speedVsContext: "Ταχύτητα σε σχέση με το μέγεθος πλαισίου",
      speedVsContextSub: "Ταχύτητα αποκωδικοποίησης σε σχέση με το μήκος πλαισίου",
      detailTitle: "Λεπτομέρειες παραγωγής",
      latestTitle: "Τελευταία παραγωγή, δευτερόλεπτο προς δευτερόλεπτο",
      latestSub: "Ταχύτητα αποκωδικοποίησης και πλήρωση πλαισίου κατά την πιο πρόσφατη εκτέλεση",
      speedAxis: "tok/s",
      contextAxis: "πλαίσιο %",
      legendSpeed: "Ταχύτητα αποκωδικοποίησης (tok/s)",
      legendContext: "Πλήρωση πλαισίου (%)",
      runAxis: "Εκτέλεση (από την παλαιότερη στη νεότερη)",
      contextSizeAxis: "Μέγεθος πλαισίου (tokens)",
      elapsedAxis: "δευτερόλεπτα",
      noSamples: "Δεν καταγράφηκαν δείγματα ανά δευτερόλεπτο για αυτή την παραγωγή.",
    },
    detail: {
      decodeSpeed: "Ταχύτητα αποκωδικοποίησης",
      nativePromptSpeed: "Εγγενής ταχύτητα prompt",
      nativeGenerationSpeed: "Εγγενής ταχύτητα παραγωγής",
      firstToken: "Πρώτο token",
      promptTokens: "Tokens prompt",
      outputTokens: "Tokens εξόδου",
      totalTokens: "Συνολικά tokens",
      context: "Παράθυρο πλαισίου",
      batch: "Λογικό batch",
      microbatch: "Microbatch",
      backend: "Backend",
      gpuLayers: "Επίπεδα GPU",
      kvType: "KV cache",
      elapsed: "Χρόνος παραγωγής",
      nativeGenerationTime: "Εγγενής υπολογισμός παραγωγής",
      appOverhead: "Επιβάρυνση εφαρμογής",
      finishReason: "Λόγος ολοκλήρωσης",
      modelSize: "Μέγεθος μοντέλου",
    },
    list: {
      title: "Πρόσφατες παραγωγές",
      speed: "{{value}} tok/s",
      ttft: "{{value}} ms",
      unknownModel: "Άγνωστο μοντέλο",
    },
